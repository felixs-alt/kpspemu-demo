      ...
      try {
        switch (this.state_0) {
          ...
          case 5:
            ...
            var instance = this.local$config.timeProvider;
            this.local$injector.mapInstance_b1ce0a$(getKClass(TimeProvider), instance);
            var instance_0 = this.local$config.module;
            this.local$injector.mapInstance_b1ce0a$(getKClass(Module), instance_0);
            this.state_0 = 6;
