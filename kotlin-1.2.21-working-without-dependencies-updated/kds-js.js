(function (root, factory) {
  ...
  var arraycopy = $module$kmem_js.com.soywiz.kmem.arraycopy_vybhjg$;
  ...
  var arraycopy_0 = $module$kmem_js.com.soywiz.kmem.arraycopy_dgpv4k$;
  ...
  var get_indices_1 = Kotlin.kotlin.collections.get_indices_tmsbgo$;
  ...
  var fill = $module$kmem_js.com.soywiz.kmem.fill_jfbbbd$;
  ...
  CircularList.prototype.addFirst_11rb$ = function (item) {
    ...
    this._start_0 = umod(this._start_0 - 1 | 0, this.capacity_0);
  ...
  CircularList.prototype.addLast_11rb$ = function (item) {
    var tmp$;
    this.resizeIfRequiredFor_0(1);
    this.data_0[umod(this._start_0 + this.size | 0, this.capacity_0)] = Kotlin.isType(tmp$ = item, Any) ? tmp$ : throwCCE();
    this._size_0 = this._size_0 + 1 | 0;
  };
  ...
  CircularList.prototype.internalIndex_0 = function (index) {
    return umod(this._start_0 + index | 0, this.capacity_0);
  };
  ...
  Object.defineProperty(DoubleArrayList.prototype, 'length', {
    get: function () {
      return this.length_cby9pa$_0;
    },
    set: function (length) {
      this.length_cby9pa$_0 = length;
    }
  });
  ...
  DoubleArrayList.prototype.add_6icyh1$ = function (values, offset, length) {
    ...
    arraycopy_0(values, offset, this.data, this.length, length);
  ...
  DoubleArrayList.prototype.removeAt_za3lpa$ = function (index) {
    ...
    if (index < (this.length - 1 | 0))
      arraycopy_0(this.data, index + 1 | 0, this.data, index, this.length - index - 1 | 0);
  ...
  function binarySearch($receiver, value) {
    return binarySearch_2($receiver.data, value, 0, $receiver.length);
  }
  ...
  DoubleCircularList.prototype.addLast_14dthe$ = function (item) {
    this.resizeIfRequiredFor_0(1);
    this.data_0[umod(this._start_0 + this.size | 0, this.capacity_0)] = item;
    this._size_0 = this._size_0 + 1 | 0;
  };
  ...
  function DoubleLinkedList(debug) {
    ...
    this.debug_0 = debug;
    this.firstSlot_0 = DoubleLinkedList$Companion_getInstance().NONE_0;
    this.lastSlot_0 = DoubleLinkedList$Companion_getInstance().NONE_0;
    ...
    this.prev_0[0] = DoubleLinkedList$Companion_getInstance().NONE_0;
    this.next_0[this.next_0.length - 1 | 0] = DoubleLinkedList$Companion_getInstance().NONE_0;
  ...
  DoubleLinkedList.prototype.get_za3lpa$ = function (index) {
    ...
    while (cslot !== DoubleLinkedList$Companion_getInstance().NONE_0) {
      var cindex_0 = cindex;
      var slot = cslot;
      if (cindex_0 === index)
  ...
  DoubleLinkedList.prototype.contains_11rb$ = function (item) {
    return this.indexOf_14dthe$(item) !== DoubleLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  DoubleLinkedList.prototype.ensure_0 = function (count) {
    ...
    if ((this.size + count | 0) >= oldCapacity) {
      ...
      this.next_0[newCapacity - 1 | 0] = DoubleLinkedList$Companion_getInstance().NONE_0;
      this.lastFreeSlot_0 = newCapacity - 1 | 0;
    }
  };
  DoubleLinkedList.prototype.addLast_14dthe$ = function (item) {
    var slot = this.allocateSlot_0();
    if (this.lastSlot_0 !== DoubleLinkedList$Companion_getInstance().NONE_0)
      this.next_0[this.lastSlot_0] = slot;
    this.next_0[slot] = DoubleLinkedList$Companion_getInstance().NONE_0;
    this.prev_0[slot] = this.lastSlot_0;
    this.items_0[slot] = item;
    if (this.firstSlot_0 === DoubleLinkedList$Companion_getInstance().NONE_0)
  ...
  DoubleLinkedList.prototype.addFirst_14dthe$ = function (item) {
    ...
    this.prev_0[slot] = DoubleLinkedList$Companion_getInstance().NONE_0;
  ...
  DoubleLinkedList.prototype.allocateSlot_0 = function () {
    ...
    if (this.firstFreeSlot_0 === DoubleLinkedList$Companion_getInstance().NONE_0) {
      throw new IllegalStateException();
    }
    this.prev_0[this.firstFreeSlot_0] = DoubleLinkedList$Companion_getInstance().NONE_0;
    return slot;
  };
  ...
  DoubleLinkedList.prototype.addBeforeSlot_5wr77w$ = function (slot, item) {
    if (slot === DoubleLinkedList$Companion_getInstance().NONE_0)
    ...
    if (this.prev_0[slot] !== DoubleLinkedList$Companion_getInstance().NONE_0) {
  ...
  DoubleLinkedList.prototype.addAfterSlot_5wr77w$ = function (slot, item) {
    ...
    if (this.next_0[slot] !== DoubleLinkedList$Companion_getInstance().NONE_0) {
  ...
  DoubleLinkedList.prototype.indexOf_14dthe$ = function (item) {
    ...
    return DoubleLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  DoubleLinkedList.prototype.remove_11rb$ = function (item) {
    ...
    return slot !== DoubleLinkedList$Companion_getInstance().NONE_0;
  };
  DoubleLinkedList.prototype.removeAt_za3lpa$ = function (index) {
    ...
    if (index >= (this.size / 2 | 0)) {
      ...
      while (cslot_1 !== DoubleLinkedList$Companion_getInstance().NONE_0) {
  ...
  DoubleLinkedList.prototype.removeSlot_za3lpa$ = function (slot) {
    ...
    if (p !== DoubleLinkedList$Companion_getInstance().NONE_0)
      this.next_0[p] = n;
    if (n !== DoubleLinkedList$Companion_getInstance().NONE_0)
      this.prev_0[n] = p;
    this.size = this.size - 1 | 0;
  ...
  DoubleLinkedList$iterator$ObjectLiteral.prototype.hasNext = function () {
    return this.cslot !== DoubleLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  Object.defineProperty(IntArrayList.prototype, 'length', {
    get: function () {
      return this.length_oa6zmg$_0;
    },
    set: function (length) {
      this.length_oa6zmg$_0 = length;
    }
  });
  ...
  IntArrayList.prototype.add_nd5v6f$ = function (values, offset, length) {
    ...
    if (length === void 0)
      length = values.length;
    this.ensure_0(values.length);
    arraycopy_1(values, offset, this.data, this.length, length);
    this.length = this.length + values.length | 0;
  };
  ...
  IntArrayList.prototype.removeAt_za3lpa$ = function (index) {
    ...
    var out = this.data[index];
    if (index < (this.length - 1 | 0))
      arraycopy_1(this.data, index + 1 | 0, this.data, index, this.length - index - 1 | 0);
    this.length = this.length - 1 | 0;
    return out;
  };
  ...
  function binarySearch_0($receiver, value) {
    return binarySearch_1($receiver.data, value, 0, $receiver.length);
  }
  ...
  function IntIntMap$Companion() {
    ...
    this.EOF_0 = kotlin_js_internal_IntCompanionObject.MAX_VALUE - 1 | 0;
    this.ZERO_INDEX_0 = kotlin_js_internal_IntCompanionObject.MAX_VALUE;
    this.EMPTY_0 = 0;
  }
  ...
  IntIntMap.prototype.grow_0 = function () {
    ...
    tmp$ = get_indices_1(this._keys_0);
    tmp$_0 = tmp$.first;
    tmp$_1 = tmp$.last;
    tmp$_2 = tmp$.step;
    for (var n = tmp$_0; n <= tmp$_1; n += tmp$_2) {
      var k = this._keys_0[n];
      if (k !== IntIntMap$Companion_getInstance().EMPTY_0)
  ...
  IntIntMap.prototype._getKeyIndex_0 = function (key) {
    var tmp$, tmp$_0;
    if (key === 0)
      return this.hasZero_0 ? IntIntMap$Companion_getInstance().ZERO_INDEX_0 : -1;
  ...
  IntIntMap.prototype.remove_za3lpa$ = function (key) {
    ...
    if (index < 0)
      return false;
    if (index === IntIntMap$Companion_getInstance().ZERO_INDEX_0) {
      this.hasZero_0 = false;
      this.zeroValue_0 = 0;
    }
     else {
      this._keys_0[index] = IntIntMap$Companion_getInstance().EMPTY_0;
    }
    this.size = this.size - 1 | 0;
    return true;
  };
  IntIntMap.prototype.clear = function () {
    this.hasZero_0 = false;
    this.zeroValue_0 = 0;
    var $receiver = this._keys_0;
    var end;
    end = $receiver.length;
    $receiver.fill(0, 0, end);
    var $receiver_0 = this._values_0;
    var end_0;
    end_0 = $receiver_0.length;
    $receiver_0.fill(0, 0, end_0);
    this.size = 0;
  };
  ...
  IntIntMap.prototype.setEmptySlot_0 = function (index, key, value) {
    if (this._keys_0[index] !== IntIntMap$Companion_getInstance().EMPTY_0)
      throw new IllegalStateException();
    ...
    retry: while (true) {
      ...
      if (index < 0) {
        ...
        if (this.size >= this.growSize_0)
          this.grow_0();
        var index1 = this.hash1_0(key);
        if (this._keys_0[index1] === IntIntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index1, key, value);
        var index2 = this.hash2_0(key);
        if (this._keys_0[index2] === IntIntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index2, key, value);
        var index3 = this.hash3_0(key);
        if (this._keys_0[index3] === IntIntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index3, key, value);
        tmp$ = this.stashStart_0;
        tmp$_0 = this._keys_0.length;
        for (var n = tmp$; n < tmp$_0; n++)
          if (this._keys_0[n] === IntIntMap$Companion_getInstance().EMPTY_0)
            return this.setEmptySlot_0(n, key, value);
        this.grow_0();
        continue retry;
      }
       else if (index === IntIntMap$Companion_getInstance().ZERO_INDEX_0) {
  ...
  function IntIntMap$Iterator($outer) {
    this.$outer = $outer;
    this.index_0 = this.$outer.hasZero_0 ? IntIntMap$Companion_getInstance().ZERO_INDEX_0 : this.nextNonEmptyIndex_0(this.$outer._keys_0, 0);
    this.entry_0 = new IntIntMap$Entry(0, 0);
  }
  IntIntMap$Iterator.prototype.hasNext = function () {
    return this.index_0 !== IntIntMap$Companion_getInstance().EOF_0;
  };
  ...
  IntIntMap$Iterator.prototype.currentKey_0 = function () {
    var tmp$;
    tmp$ = this.index_0;
    if (tmp$ === IntIntMap$Companion_getInstance().ZERO_INDEX_0 || tmp$ === IntIntMap$Companion_getInstance().EOF_0)
      return 0;
    else
      return this.$outer._keys_0[this.index_0];
  };
  IntIntMap$Iterator.prototype.currentValue_0 = function () {
    var tmp$;
    tmp$ = this.index_0;
    if (tmp$ === IntIntMap$Companion_getInstance().ZERO_INDEX_0)
      return this.$outer.zeroValue_0;
    else if (tmp$ === IntIntMap$Companion_getInstance().EOF_0)
      return 0;
    else
  ...
  IntIntMap$Iterator.prototype.nextNonEmptyIndex_0 = function (keys, offset) {
    for (var n = offset; n < keys.length; n++)
      if (keys[n] !== IntIntMap$Companion_getInstance().EMPTY_0)
        return n;
    return IntIntMap$Companion_getInstance().EOF_0;
  };
  IntIntMap$Iterator.prototype.next_0 = function () {
    if (this.index_0 !== IntIntMap$Companion_getInstance().EOF_0)
      this.index_0 = this.nextNonEmptyIndex_0(this.$outer._keys_0, this.index_0 === IntIntMap$Companion_getInstance().ZERO_INDEX_0 ? 0 : this.index_0 + 1 | 0);
  };
  ...
  function IntLinkedList(debug) {
    ...
    this.debug_0 = debug;
    this.firstSlot_0 = IntLinkedList$Companion_getInstance().NONE_0;
    this.lastSlot_0 = IntLinkedList$Companion_getInstance().NONE_0;
    this.firstFreeSlot_0 = 0;
    this.lastFreeSlot_0 = 15;
    ...
    this.prev_0[0] = IntLinkedList$Companion_getInstance().NONE_0;
    this.next_0[this.next_0.length - 1 | 0] = IntLinkedList$Companion_getInstance().NONE_0;
    this.checkInternalState_0();
  }
  ...
  IntLinkedList.prototype.get_za3lpa$ = function (index) {
    ...
    var cindex = 0;
    var cslot = this.firstSlot_0;
    while (cslot !== IntLinkedList$Companion_getInstance().NONE_0) {
      var cindex_0 = cindex;
      var slot = cslot;
      if (cindex_0 === index)
        return this.items_0[slot];
  ...
  IntLinkedList.prototype.contains_11rb$ = function (item) {
    return this.indexOf_za3lpa$(item) !== IntLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  IntLinkedList.prototype.ensure_0 = function (count) {
    ...
    if ((this.size + count | 0) >= oldCapacity) {
      ...
      this.prev_0[oldCapacity] = this.lastFreeSlot_0;
      this.next_0[this.lastFreeSlot_0] = oldCapacity;
      this.next_0[newCapacity - 1 | 0] = IntLinkedList$Companion_getInstance().NONE_0;
      this.lastFreeSlot_0 = newCapacity - 1 | 0;
    }
  };
  IntLinkedList.prototype.addLast_za3lpa$ = function (item) {
    var slot = this.allocateSlot_0();
    if (this.lastSlot_0 !== IntLinkedList$Companion_getInstance().NONE_0)
      this.next_0[this.lastSlot_0] = slot;
    this.next_0[slot] = IntLinkedList$Companion_getInstance().NONE_0;
    this.prev_0[slot] = this.lastSlot_0;
    this.items_0[slot] = item;
    if (this.firstSlot_0 === IntLinkedList$Companion_getInstance().NONE_0)
      this.firstSlot_0 = slot;
    this.lastSlot_0 = slot;
    this.size = this.size + 1 | 0;
    this.checkInternalState_0();
  ...
  IntLinkedList.prototype.addFirst_za3lpa$ = function (item) {
    ...
    if (this.firstSlot_0 !== IntLinkedList$Companion_getInstance().NONE_0)
      this.prev_0[this.firstSlot_0] = slot;
    this.prev_0[slot] = IntLinkedList$Companion_getInstance().NONE_0;
    this.next_0[slot] = this.firstSlot_0;
    this.items_0[slot] = item;
    if (this.lastSlot_0 === IntLinkedList$Companion_getInstance().NONE_0)
      this.lastSlot_0 = slot;
  ...
  IntLinkedList.prototype.allocateSlot_0 = function () {
    ...
    var slot = this.firstFreeSlot_0;
    this.firstFreeSlot_0 = this.next_0[this.firstFreeSlot_0];
    if (this.firstFreeSlot_0 === IntLinkedList$Companion_getInstance().NONE_0) {
      throw new IllegalStateException();
    }
    this.prev_0[this.firstFreeSlot_0] = IntLinkedList$Companion_getInstance().NONE_0;
    return slot;
  };
  ...
  IntLinkedList.prototype.addBeforeSlot_vux9f0$ = function (slot, item) {
    if (slot === IntLinkedList$Companion_getInstance().NONE_0)
      throw new IllegalArgumentException();
    var newSlot = this.allocateSlot_0();
    this.items_0[newSlot] = item;
    this.prev_0[newSlot] = this.prev_0[slot];
    this.next_0[newSlot] = slot;
    if (this.prev_0[slot] !== IntLinkedList$Companion_getInstance().NONE_0) {
      this.next_0[this.prev_0[slot]] = newSlot;
    }
    this.prev_0[slot] = newSlot;
    if (this.firstSlot_0 === slot) {
  ...
  IntLinkedList.prototype.addAfterSlot_vux9f0$ = function (slot, item) {
    ...
    this.next_0[newSlot] = this.next_0[slot];
    this.prev_0[newSlot] = slot;
    if (this.next_0[slot] !== IntLinkedList$Companion_getInstance().NONE_0) {
      this.prev_0[this.next_0[slot]] = newSlot;
    }
    this.next_0[slot] = newSlot;
    this.items_0[newSlot] = item;
  ...
  IntLinkedList.prototype.indexOf_za3lpa$ = function (item) {
    ...
    return IntLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  IntLinkedList.prototype.remove_11rb$ = function (item) {
    ...
    if (slot !== IntLinkedList$Companion_getInstance().NONE_0)
      this.removeSlot_za3lpa$(slot);
    return slot !== IntLinkedList$Companion_getInstance().NONE_0;
  };
  IntLinkedList.prototype.removeAt_za3lpa$ = function (index) {
    ...
    if (index >= (this.size / 2 | 0)) {
      ...
      var cindex_1 = 0;
      var cslot_1 = this.firstSlot_0;
      while (cslot_1 !== IntLinkedList$Companion_getInstance().NONE_0) {
        var cindex_2 = cindex_1;
        var cslot_2 = cslot_1;
        if (cindex_2 === index)
          return this.removeSlot_za3lpa$(cslot_2);
  ...
  IntLinkedList.prototype.removeSlot_za3lpa$ = function (slot) {
    ...
    var p = this.prev_0[slot];
    var n = this.next_0[slot];
    if (p !== IntLinkedList$Companion_getInstance().NONE_0)
      this.next_0[p] = n;
    if (n !== IntLinkedList$Companion_getInstance().NONE_0)
      this.prev_0[n] = p;
    this.size = this.size - 1 | 0;
    this.freeSlot_0(slot);
    this.checkInternalState_0();
  ...
  IntLinkedList$iterator$ObjectLiteral.prototype.hasNext = function () {
    return this.cslot !== IntLinkedList$Companion_getInstance().NONE_0;
  };
  ...
  IntMap.prototype.grow_0 = function () {
    ...
    for (var n = tmp$_0; n <= tmp$_1; n += tmp$_2) {
      var k = this._keys_0[n];
      if (k !== IntMap$Companion_getInstance().EMPTY_0)
  ...
  IntMap.prototype._getKeyIndex_0 = function (key) {
    var tmp$, tmp$_0;
    if (key === 0)
      return this.hasZero_0 ? IntMap$Companion_getInstance().ZERO_INDEX_0 : -1;
    var index1 = this.hash1_0(key);
    if (this._keys_0[index1] === key)
      return index1;
    var index2 = this.hash2_0(key);
  ...
  IntMap.prototype.remove_za3lpa$ = function (key) {
    ...
    if (index < 0)
      return false;
    if (index === IntMap$Companion_getInstance().ZERO_INDEX_0) {
      this.hasZero_0 = false;
      this.zeroValue_0 = null;
    }
     else {
      this._keys_0[index] = IntMap$Companion_getInstance().EMPTY_0;
    }
    this.size = this.size - 1 | 0;
    return true;
  };
  ...
  IntMap.prototype.setEmptySlot_0 = function (index, key, value) {
    if (this._keys_0[index] !== IntMap$Companion_getInstance().EMPTY_0)
      throw new IllegalStateException();
    this._keys_0[index] = key;
    this._values_0[index] = value;
    this.size = this.size + 1 | 0;
    ...
    retry: while (true) {
      ...
      if (index < 0) {
        ...
        if (this.size >= this.growSize_0)
          this.grow_0();
        var index1 = this.hash1_0(key);
        if (this._keys_0[index1] === IntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index1, key, value);
        var index2 = this.hash2_0(key);
        if (this._keys_0[index2] === IntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index2, key, value);
        var index3 = this.hash3_0(key);
        if (this._keys_0[index3] === IntMap$Companion_getInstance().EMPTY_0)
          return this.setEmptySlot_0(index3, key, value);
        tmp$ = this.stashStart_0;
        tmp$_0 = this._keys_0.length;
        for (var n = tmp$; n < tmp$_0; n++)
          if (this._keys_0[n] === IntMap$Companion_getInstance().EMPTY_0)
            return this.setEmptySlot_0(n, key, value);
        this.grow_0();
        continue retry;
      }
       else if (index === IntMap$Companion_getInstance().ZERO_INDEX_0) {
        var $receiver = this.zeroValue_0;
        this.zeroValue_0 = value;
        return $receiver;
      }
  ...
  function IntMap$Iterator($outer) {
    this.$outer = $outer;
    this.index_0 = this.$outer.hasZero_0 ? IntMap$Companion_getInstance().ZERO_INDEX_0 : this.nextNonEmptyIndex_0(this.$outer._keys_0, 0);
    this.entry_0 = new IntMap$Entry(0, null);
  }
  IntMap$Iterator.prototype.hasNext = function () {
    return this.index_0 !== IntMap$Companion_getInstance().EOF_0;
  };
  ...
  IntMap$Iterator.prototype.currentKey_0 = function () {
    var tmp$;
    tmp$ = this.index_0;
    if (tmp$ === IntMap$Companion_getInstance().ZERO_INDEX_0 || tmp$ === IntMap$Companion_getInstance().EOF_0)
      return 0;
    else
      return this.$outer._keys_0[this.index_0];
  };
  IntMap$Iterator.prototype.currentValue_0 = function () {
    var tmp$;
    tmp$ = this.index_0;
    if (tmp$ === IntMap$Companion_getInstance().ZERO_INDEX_0)
      return this.$outer.zeroValue_0;
    else if (tmp$ === IntMap$Companion_getInstance().EOF_0)
      return null;
    else
      return this.$outer._values_0[this.index_0];
  };
  IntMap$Iterator.prototype.nextNonEmptyIndex_0 = function (keys, offset) {
    for (var n = offset; n < keys.length; n++)
      if (keys[n] !== IntMap$Companion_getInstance().EMPTY_0)
        return n;
    return IntMap$Companion_getInstance().EOF_0;
  };
  IntMap$Iterator.prototype.next_0 = function () {
    if (this.index_0 !== IntMap$Companion_getInstance().EOF_0)
      this.index_0 = this.nextNonEmptyIndex_0(this.$outer._keys_0, this.index_0 === IntMap$Companion_getInstance().ZERO_INDEX_0 ? 0 : this.index_0 + 1 | 0);
  };
  ...
  function LinkedList(debug) {
    ...
    this.debug_0 = debug;
    this.firstSlot_0 = LinkedList$Companion_getInstance().NONE_0;
    this.lastSlot_0 = LinkedList$Companion_getInstance().NONE_0;
    this.firstFreeSlot_0 = 0;
    this.lastFreeSlot_0 = 15;
    ...
    this.prev_0[0] = LinkedList$Companion_getInstance().NONE_0;
    this.next_0[this.next_0.length - 1 | 0] = LinkedList$Companion_getInstance().NONE_0;
    this.checkInternalState_0();
  }
  ...
  LinkedList.prototype.get_za3lpa$ = function (index) {
    ...
    var cindex = 0;
    var cslot = this.firstSlot_0;
    while (cslot !== LinkedList$Companion_getInstance().NONE_0) {
      var cindex_0 = cindex;
      var slot = cslot;
      if (cindex_0 === index)
        return this.items_0[slot];
  ...
  LinkedList.prototype.contains_11rb$ = function (item) {
    return this.indexOf_11rb$(item) !== LinkedList$Companion_getInstance().NONE_0;
  };
  ...
  LinkedList.prototype.ensure_0 = function (count) {
    ...
    if ((this.size + count | 0) >= oldCapacity) {
      ...
      this.prev_0[oldCapacity] = this.lastFreeSlot_0;
      this.next_0[this.lastFreeSlot_0] = oldCapacity;
      this.next_0[newCapacity - 1 | 0] = LinkedList$Companion_getInstance().NONE_0;
      this.lastFreeSlot_0 = newCapacity - 1 | 0;
    }
  };
  LinkedList.prototype.addLast_11rb$ = function (item) {
    var slot = this.allocateSlot_0();
    if (this.lastSlot_0 !== LinkedList$Companion_getInstance().NONE_0)
      this.next_0[this.lastSlot_0] = slot;
    this.next_0[slot] = LinkedList$Companion_getInstance().NONE_0;
    this.prev_0[slot] = this.lastSlot_0;
    this.items_0[slot] = item;
    if (this.firstSlot_0 === LinkedList$Companion_getInstance().NONE_0)
      this.firstSlot_0 = slot;
    this.lastSlot_0 = slot;
    this.size = this.size + 1 | 0;
    this.checkInternalState_0();
  ...
  LinkedList.prototype.addFirst_11rb$ = function (item) {
    ...
    if (this.firstSlot_0 !== LinkedList$Companion_getInstance().NONE_0)
      this.prev_0[this.firstSlot_0] = slot;
    this.prev_0[slot] = LinkedList$Companion_getInstance().NONE_0;
    this.next_0[slot] = this.firstSlot_0;
    this.items_0[slot] = item;
    if (this.lastSlot_0 === LinkedList$Companion_getInstance().NONE_0)
      this.lastSlot_0 = slot;
  ...
  LinkedList.prototype.allocateSlot_0 = function () {
    ...
    var slot = this.firstFreeSlot_0;
    this.firstFreeSlot_0 = this.next_0[this.firstFreeSlot_0];
    if (this.firstFreeSlot_0 === LinkedList$Companion_getInstance().NONE_0) {
      throw new IllegalStateException();
    }
    this.prev_0[this.firstFreeSlot_0] = LinkedList$Companion_getInstance().NONE_0;
    return slot;
  };
  ...
  LinkedList.prototype.addBeforeSlot_wxm5ur$ = function (slot, item) {
    if (slot === LinkedList$Companion_getInstance().NONE_0)
      throw new IllegalArgumentException();
    var newSlot = this.allocateSlot_0();
    this.items_0[newSlot] = item;
    this.prev_0[newSlot] = this.prev_0[slot];
    this.next_0[newSlot] = slot;
    if (this.prev_0[slot] !== LinkedList$Companion_getInstance().NONE_0) {
      this.next_0[this.prev_0[slot]] = newSlot;
    }
    this.prev_0[slot] = newSlot;
    if (this.firstSlot_0 === slot) {
  ...
  LinkedList.prototype.addAfterSlot_wxm5ur$ = function (slot, item) {
    ...
    this.next_0[newSlot] = this.next_0[slot];
    this.prev_0[newSlot] = slot;
    if (this.next_0[slot] !== LinkedList$Companion_getInstance().NONE_0) {
      this.prev_0[this.next_0[slot]] = newSlot;
    }
    this.next_0[slot] = newSlot;
    this.items_0[newSlot] = item;
  ...
  LinkedList.prototype.indexOf_11rb$ = function (item) {
    ...
    return LinkedList$Companion_getInstance().NONE_0;
  };
  ...
  LinkedList.prototype.remove_11rb$ = function (item) {
    ...
    if (slot !== LinkedList$Companion_getInstance().NONE_0)
      this.removeSlot_za3lpa$(slot);
    return slot !== LinkedList$Companion_getInstance().NONE_0;
  };
  LinkedList.prototype.removeAt_za3lpa$ = function (index) {
    ...
    if (index >= (this.size / 2 | 0)) {
      ...
      var cindex_1 = 0;
      var cslot_1 = this.firstSlot_0;
      while (cslot_1 !== LinkedList$Companion_getInstance().NONE_0) {
        var cindex_2 = cindex_1;
        var cslot_2 = cslot_1;
        if (cindex_2 === index)
          return this.removeSlot_za3lpa$(cslot_2);
  ...
  LinkedList.prototype.removeSlot_za3lpa$ = function (slot) {
    ...
    var p = this.prev_0[slot];
    var n = this.next_0[slot];
    if (p !== LinkedList$Companion_getInstance().NONE_0)
      this.next_0[p] = n;
    if (n !== LinkedList$Companion_getInstance().NONE_0)
      this.prev_0[n] = p;
    this.size = this.size - 1 | 0;
    this.freeSlot_0(slot);
    this.checkInternalState_0();
  ...
  LinkedList$iterator$ObjectLiteral.prototype.hasNext = function () {
    return this.cslot !== LinkedList$Companion_getInstance().NONE_0;
  };
  ...
  package$kds.DoubleArrayList_init_gf7tl1$ = DoubleArrayList_init_0;
  ...
  package$kds.IntArrayList_init_q5rwfd$ = IntArrayList_init_0;
  ...
  package$kds.divCeil_dqglrj$ = divCeil;
  package$kds.umod_dqglrj$ = umod;
  package$kds.ilog2_za3lpa$ = ilog2;
  ...
  Object.defineProperty(package$kds, 'KDS_VERSION_8be2vx$', {
    get: function () {
      return KDS_VERSION;
    }
  });
  ...
  package$kds.toTreeMap_awek33$ = toTreeMap;
