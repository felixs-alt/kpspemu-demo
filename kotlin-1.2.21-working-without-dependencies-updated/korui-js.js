(function (root, factory) {
  ...
  function get_defaultLightFactory() {
    new PropertyMetadata('defaultLightFactory');
  ...
  function get_defaultLight() {
    new PropertyMetadata('defaultLight');
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.button_7vtrb7$', wrapFunction(function () {
    ...
    return function ($receiver, text, callback, continuation) {
      ...
      coroutineReceiver();
      await_0(callback, $receiver_1, coroutineReceiver());
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.image_uhrqwu$', wrapFunction(function () {
    ...
    return function ($receiver, bitmap, callback, continuation) {
      ...
      coroutineReceiver();
      var closure$continuation = coroutineReceiver();
      $receiver_1.image = bitmap;
      await_0(callback, $receiver_1, closure$continuation);
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  ...
  function get_mouseEventOnce($receiver) {
    var property = new PropertyMetadata('mouseEventOnce');
  ...
  function get_keyEventOnce($receiver) {
    var property = new PropertyMetadata('keyEventOnce');
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_touchEventOnce($receiver) {
    var property = new PropertyMetadata('touchEventOnce');
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_gamepadEventOnce($receiver) {
    var property = new PropertyMetadata('gamepadEventOnce');
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_changeEventOnce($receiver) {
    var property = new PropertyMetadata('changeEventOnce');
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onMouseUp($receiver) {
    var property = new PropertyMetadata('onMouseUp');
  ...
  function get_onMouseDown($receiver) {
    var property = new PropertyMetadata('onMouseDown');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onMouseClick($receiver) {
    var property = new PropertyMetadata('onMouseClick');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onMouseOver($receiver) {
    var property = new PropertyMetadata('onMouseOver');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onMouseEnter($receiver) {
    var property = new PropertyMetadata('onMouseEnter');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onMouseExit($receiver) {
    var property = new PropertyMetadata('onMouseExit');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onKeyTyped($receiver) {
    var property = new PropertyMetadata('onKeyTyped');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onKeyDown($receiver) {
    var property = new PropertyMetadata('onKeyDown');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onKeyUp($receiver) {
    var property = new PropertyMetadata('onKeyUp');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onTouchStart($receiver) {
    var property = new PropertyMetadata('onTouchStart');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onTouchEnd($receiver) {
    var property = new PropertyMetadata('onTouchEnd');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onTouchMove($receiver) {
    var property = new PropertyMetadata('onTouchMove');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onGamepadDown($receiver) {
    var property = new PropertyMetadata('onGamepadDown');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onGamepadUp($receiver) {
    var property = new PropertyMetadata('onGamepadUp');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  function get_onChange($receiver) {
    var property = new PropertyMetadata('onChange');
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
  ...
  Layout.prototype.genAxisBounds_4ixdkk$ = function (size, list, itemSize, paddingPrev, paddingNext, scaled) {
    ...
    if (equals(scaled, Layout$ScaleMode2$SHRINK_getInstance()))
      tmp$_0 = pos > size ? scaleFit : 1.0;
    else if (equals(scaled, Layout$ScaleMode2$ALWAYS_getInstance()))
      tmp$_0 = scaleFit;
    else if (equals(scaled, Layout$ScaleMode2$NEVER_getInstance()))
      tmp$_0 = 1.0;
    else
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.vectorImage_lz2sxk$', wrapFunction(function () {
    ...
    return function ($receiver, vector, callback, continuation) {
      ...
      coroutineReceiver();
      var closure$continuation = coroutineReceiver();
      $receiver_1.setVector_qmzsv0$(vector, vector.width, vector.height, closure$continuation);
      callback($receiver_1);
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            var $receiver = new Image(this.$this.app);
            ...
            this.result_0 = this.$this.add_x0aukp$($receiver);
  ...
  HtmlLightComponents.prototype.create_3wpq0m$ = function (type) {
    ...
    if (equals(type, LightType$FRAME_getInstance())) {
      ...
      var $receiver_9 = Kotlin.isType(tmp$_10 = document.createElement('div'), HTMLElement) ? tmp$_10 : throwCCE();
  ...
  HtmlLightComponents.prototype.dialogPrompt_h80hvh$$default = function (c, message, initialValue, continuation) {
    return suspendCoroutine$lambda_0(_korioSuspendCoroutine$lambda_0(korioSuspendCoroutine$lambda_0(HtmlLightComponents$dialogPrompt$lambda(message, initialValue))))(continuation.facade);
  };
  ...
  SelectedFilesVfs.prototype.open_j4ip3x$ = function (path_0, mode, continuation_0, suspended) {
    var instance = new Coroutine$open_j4ip3x$(this, path_0, mode, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$open_j4ip3x$($this, path_0, mode, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            tmp$ = this.$this.locate_0(this.local$path);
            if (tmp$ == null) {
              throw new FileNotFoundException(this.local$path);
            }

            var jsfile = tmp$;
            var jsstat = this.$this.jsstat_0(jsfile);
