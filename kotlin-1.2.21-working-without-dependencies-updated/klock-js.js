(function (root, factory) {
  ...
  function KlockExt() {
    KlockExt_instance = this;
    this.VERSION = KLOCK_VERSION;
  }
  KlockExt.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'KlockExt',
  ...
  var KlockExt_instance = null;
  function KlockExt_getInstance() {
    if (KlockExt_instance === null) {
      new KlockExt();
    }
    return KlockExt_instance;
  }
  var KLOCK_VERSION;
  ...
  DateTime.prototype.addWeeks_14dthe$ = function (delta) {
    return this.add_6svq3l$(0, Kotlin.Long.fromNumber(delta * MILLIS_PER_WEEK));
  };
  ...
  UtcDateTime$Companion.prototype.timeToMillisUnchecked_cub51b$ = function (hour, minute, second) {
    return Kotlin.Long.fromInt(hour).multiply(Kotlin.Long.fromInt(3600)).add(Kotlin.Long.fromInt(minute).multiply(Kotlin.Long.fromInt(60))).add(Kotlin.Long.fromInt(second)).multiply(Kotlin.Long.fromInt(MILLIS_PER_SECOND));
  };
  ...
  UtcDateTime.prototype.add_6svq3l$ = function (deltaMonths, deltaMilliseconds) {
    if (deltaMonths === 0 && equals(deltaMilliseconds, Kotlin.Long.ZERO))
      ...
      if (day > days)
        day = days;
      return new UtcDateTime(UtcDateTime$Companion_getInstance().dateToMillisUnchecked_cub51b$(year, month, day).add(this.internalMillis_8be2vx$.modulo(Kotlin.Long.fromInt(MILLIS_PER_DAY))).add(deltaMilliseconds), true);
    }
  };
  ...
  TimeSpan$Companion.prototype.toTimeStringRaw_0 = function (totalMilliseconds, components) {
    ...
    for (var n = 0; n < components; n++) {
      ...
      tmp$_0 = (tmp$ = this.timeSteps_0) != null ? getOrNull(tmp$, n) : null;
      if (tmp$_0 == null) {
        throw new RuntimeException('Just supported ' + this.timeSteps_0.size + ' steps');
      }
      var step = tmp$_0;
  ...
  TimeSpan.prototype.toTimeString_fzusl$ = function (components, addMilliseconds) {
    if (components === void 0)
      components = 3;
    if (addMilliseconds === void 0)
      addMilliseconds = false;
    return TimeSpan$Companion_getInstance().toTimeString_ydzd23$(this.milliseconds, components, addMilliseconds);
  };
  TimeSpan.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'TimeSpan',
  ...
  function SimplerDateFormat(format) {
    ...
    replace_20wsma$break: do {
      ...
      do {
        ...
        if (startsWith(v, "'")) {
          transform$result = '(' + Regex_0.Companion.escapeReplacement_61zpoe$(trim(v, Kotlin.charArrayOf(39))) + ')';
        }
         else {
          transform$result = '([\\w\\+\\-]+)';
        }
  ...
  Object.defineProperty(SimplerDateFormat$Companion.prototype, 'FORMAT1', {
    get: function () {
      var $receiver = this.FORMAT1_nnjo7b$_0;
      new PropertyMetadata('FORMAT1');
      return $receiver.value;
    }
  });
  ...
  function Klock() {
    Klock_instance = this;
    this.VERSION = KlockExt_getInstance().VERSION;
  }
  ...
  Object.defineProperty(package$klock, 'KlockExt', {
    get: KlockExt_getInstance
  });
  Object.defineProperty(package$klock, 'KLOCK_VERSION_8be2vx$', {
    get: function () {
  ...
  MILLIS_PER_WEEK = MILLIS_PER_DAY * 7 | 0;
  DAYS_PER_YEAR = 365;
