(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'korio-js', 'kmem-js', 'korim-js', 'kds-js', 'korma-js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('korio-js'), require('kmem-js'), require('korim-js'), require('kds-js'), require('korma-js'));
  else {
    ...
    root['korag-js'] = factory(typeof this['korag-js'] === 'undefined' ? {} : this['korag-js'], kotlin, this['korio-js'], this['kmem-js'], this['korim-js'], this['kds-js'], this['korma-js']);
  }
}(this, function (_, Kotlin, $module$korio_js, $module$kmem_js, $module$korim_js, $module$kds_js, $module$korma_js) {
  'use strict';
  ...
  function get_defaultFactory() {
    new PropertyMetadata('defaultFactory');
  ...
  function get_agFactory() {
    new PropertyMetadata('agFactory');
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            tmp$ = this.result_0;
            this.local$this$Texture.tempBitmap_rlmwj0$_0 = tmp$;
  ...
  function AG$Texture$Kind$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant com.soywiz.korag.AG.Texture.Kind.' + name);
    }
  }
  ...
  AG$Buffer.prototype.upload_1bktx$ = function (data, offset, length) {
    if (offset === void 0)
      offset = 0;
    if (length === void 0)
      length = data.size;
  ...
  Object.defineProperty(AG.prototype, 'dummyTexture', {
    get: function () {
      ...
      new PropertyMetadata('dummyTexture');
  ...
  AG.prototype.createIndexBuffer_1bktx$ = function (data, offset, length) {
    if (offset === void 0)
      offset = 0;
    if (length === void 0)
      length = data.size - offset | 0;
    var $receiver = this.createIndexBuffer();
    $receiver.upload_1bktx$(data, offset, length);
    return $receiver;
  };
  ...
  AG.prototype.createVertexBuffer_1bktx$ = function (data, offset, length) {
    if (offset === void 0)
      offset = 0;
    if (length === void 0)
      length = data.size - offset | 0;
  ...
  AG.prototype.draw_3hoar0$ = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask) {
    if (indices === void 0)
      indices = null;
    if (offset === void 0)
      offset = 0;
    ...
    this.draw_n1yu8b$(vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, this.dummyRenderState_xrscgh$_0);
  };
  AG.prototype.draw_n1yu8b$$default = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState) {
  };
  AG.prototype.draw_n1yu8b$ = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState, callback$default) {
    if (indices === void 0)
      indices = null;
    if (offset === void 0)
      offset = 0;
    ...
    callback$default ? callback$default(vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState) : this.draw_n1yu8b$$default(vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState);
  };
  ...
  AG.prototype.renderToBitmapEx_earh6w$ = defineInlineFunction('korag-js.com.soywiz.korag.AG.renderToBitmapEx_earh6w$', function (bmp, callback) {
    var rb = this.renderBuffers.alloc();
    var oldRendering = this.renderingToTexture;
    this.renderingToTexture = true;
    rb.start_vux9f0$(bmp.width, bmp.height);
  ...
  Object.defineProperty(DefaultShaders.prototype, 'PROGRAM_DEFAULT', {
    get: function () {
      ...
      new PropertyMetadata('PROGRAM_DEFAULT');
      return $receiver.value;
    }
  });
    ...
    try {
      ...
      while (tmp$_1.hasNext()) {
        ...
        while (tmp$_2.hasNext()) {
          var tmp$_6 = tmp$_2.next();
          var attribute = tmp$_6.component1()
          , pos = tmp$_6.component2();
          var o = os + pos + vertexMemOffset | 0;
          tmp$_3 = attribute.type;
          if (equals(tmp$_3, VarType$Int1_getInstance()))
            tmp$_4 = 'int(' + toString(vertexMem.getInt32_za3lpa$(o + 0 | 0)) + ')';
          else if (equals(tmp$_3, VarType$Float1_getInstance()))
            tmp$_4 = 'float(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ')';
          else if (equals(tmp$_3, VarType$Float2_getInstance()))
            tmp$_4 = 'vec2(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 4 | 0)) + ')';
          else if (equals(tmp$_3, VarType$Float3_getInstance()))
            tmp$_4 = 'vec3(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 4 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 8 | 0)) + ')';
          else if (equals(tmp$_3, VarType$Byte4_getInstance()))
            tmp$_4 = 'byte4(' + toString(vertexMem.getInt32_za3lpa$(o + 0 | 0)) + ')';
          else
            tmp$_4 = 'Unsupported(' + attribute.type + ')';
          var info = tmp$_4;
  ...
  GlslGenerator.prototype.typeToString_b2kxjc$ = function (type) {
    ...
    if (equals(type, VarType$Byte4_getInstance()))
      return 'vec4';
    else if (equals(type, VarType$Mat4_getInstance()))
      return 'mat4';
    else if (equals(type, VarType$TextureUnit_getInstance()))
      return 'sampler2D';
    else {
      tmp$ = type.kind;
      if (equals(tmp$, VarKind$BYTE_getInstance()) || equals(tmp$, VarKind$UNSIGNED_BYTE_getInstance()) || equals(tmp$, VarKind$SHORT_getInstance()) || equals(tmp$, VarKind$UNSIGNED_SHORT_getInstance()) || equals(tmp$, VarKind$FLOAT_getInstance())) {
        tmp$_0 = type.elementCount;
        if (tmp$_0 === 1)
          return 'float';
        else if (tmp$_0 === 2)
          return 'vec2';
       ...
       else if (equals(tmp$, VarKind$INT_getInstance())) {
        tmp$_1 = type.elementCount;
        if (tmp$_1 === 1)
          return 'int';
        else if (tmp$_1 === 2)
          return 'ivec2';
  ...
  GlslGenerator.prototype.visit_bmfbl7$ = function (operand) {
    ...
    if (Kotlin.isType(operand, Output)) {
      ...
      tmp$ = this.kind;
      if (equals(tmp$, ShaderType$VERTEX_getInstance()))
        tmp$_0 = 'gl_Position';
      else if (equals(tmp$, ShaderType$FRAGMENT_getInstance()))
        tmp$_0 = 'gl_FragColor';
      else
  ...
  function Uniform(name, type) {
    ...
    Variable.call(this, name, type);
    var tmp$;
    this.uid = (tmp$ = Uniform$Companion_getInstance().lastUid, Uniform$Companion_getInstance().lastUid = tmp$ + 1 | 0, tmp$);
  }
  ...
  Object.defineProperty(Program.prototype, 'attributes', {
    get: function () {
      ...
      new PropertyMetadata('attributes');
      return $receiver.value;
    }
  });
  ...
  function AGWebgl() {
    ...
    this.agInput_txyt6p$_0 = new AGInput();
    var tmp$, tmp$_0;
    ...
    var event = new AGInput$KeyEvent();
    this.canvas.addEventListener('keydown', AGWebgl_init$lambda_1(event, this), false);
    this.canvas.addEventListener('keyup', AGWebgl_init$lambda_2(event, this), false);
    this.canvas.addEventListener('keypress', AGWebgl_init$lambda_3(event, this), false);
  ...
  Object.defineProperty(AGWebgl.prototype, 'agInput', {
    get: function () {
      return this.agInput_txyt6p$_0;
    }
  });
  ...
  function AGWebgl$MyUniformLocation(location) {
    this.location = location;
  }
  AGWebgl$MyUniformLocation.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'MyUniformLocation',
    interfaces: []
  };
  AGWebgl$MyUniformLocation.prototype.component1 = function () {
    return this.location;
  };
  AGWebgl$MyUniformLocation.prototype.copy_22ndcq$ = function (location) {
    return new AGWebgl$MyUniformLocation(location === void 0 ? this.location : location);
  };
  AGWebgl$MyUniformLocation.prototype.toString = function () {
    return 'MyUniformLocation(location=' + Kotlin.toString(this.location) + ')';
  };
  AGWebgl$MyUniformLocation.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.location) | 0;
    return result;
  };
  AGWebgl$MyUniformLocation.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.location, other.location))));
  };
  function AGWebgl$WebglProgram($outer, p) {
    ...
    this.vertex = null;
    this.fragment = null;
    this.uniformLocations = HashMap_init();
  }
  AGWebgl$WebglProgram.prototype.createShader_19mbxw$ = function (type, source) {
    ...
    if (!success) {
      ...
      lang.Console.error_s8jyv4$(toString(shader));
  ...
  AGWebgl$WebglProgram.prototype.uniformLocation_2f4vi3$ = function (uniform) {
    var $receiver = this.uniformLocations;
    this.$outer;
    var tmp$;
    var value = $receiver.get_11rb$(uniform);
    if (value == null) {
      var answer = new AGWebgl$MyUniformLocation(this.$outer.gl.getUniformLocation(this.program, uniform.name));
      $receiver.put_xwzc9p$(uniform, answer);
      tmp$ = answer;
    }
     else {
      tmp$ = value;
  ...
  function AGWebgl$WebglTexture($outer, premultiplied) {
    this.$outer = $outer;
    AG$Texture.call(this);
    this.premultiplied_vvmzdn$_0 = premultiplied;
    this.cachedVersion = -1;
    this._tex_0 = null;
  }
  Object.defineProperty(AGWebgl$WebglTexture.prototype, 'premultiplied', {
    get: function () {
      return this.premultiplied_vvmzdn$_0;
    }
  });
  ...
  AGWebgl.prototype.createTexture_6taknv$ = function (premultiplied) {
    return new AGWebgl$WebglTexture(this, premultiplied);
  };
  ...
  AGWebgl.prototype.get_webglElementType_bxje6x$ = function ($receiver) {
    var tmp$;
    tmp$ = $receiver.kind;
    if (equals(tmp$, VarKind$BYTE_getInstance()))
      return WebGLRenderingContext.BYTE;
    else if (equals(tmp$, VarKind$UNSIGNED_BYTE_getInstance()))
      return WebGLRenderingContext.UNSIGNED_BYTE;
    else if (equals(tmp$, VarKind$SHORT_getInstance()))
      return WebGLRenderingContext.SHORT;
    else if (equals(tmp$, VarKind$UNSIGNED_SHORT_getInstance()))
      return WebGLRenderingContext.UNSIGNED_SHORT;
    else if (equals(tmp$, VarKind$INT_getInstance()))
      return WebGLRenderingContext.INT;
    else if (equals(tmp$, VarKind$FLOAT_getInstance()))
      return WebGLRenderingContext.FLOAT;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.get_glDrawMode_7dvn3b$ = function ($receiver) {
    if (equals($receiver, AG$DrawType$POINTS_getInstance()))
      return WebGLRenderingContext.POINTS;
    else if (equals($receiver, AG$DrawType$LINE_STRIP_getInstance()))
      return WebGLRenderingContext.LINE_STRIP;
    else if (equals($receiver, AG$DrawType$LINE_LOOP_getInstance()))
      return WebGLRenderingContext.LINE_LOOP;
    else if (equals($receiver, AG$DrawType$LINES_getInstance()))
      return WebGLRenderingContext.LINES;
    else if (equals($receiver, AG$DrawType$TRIANGLE_STRIP_getInstance()))
      return WebGLRenderingContext.TRIANGLE_STRIP;
    else if (equals($receiver, AG$DrawType$TRIANGLE_FAN_getInstance()))
      return WebGLRenderingContext.TRIANGLE_FAN;
    else if (equals($receiver, AG$DrawType$TRIANGLES_getInstance()))
      return WebGLRenderingContext.TRIANGLES;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.toGl_0 = function ($receiver) {
    if (equals($receiver, AG$BlendEquation$ADD_getInstance()))
      return WebGLRenderingContext.FUNC_ADD;
    else if (equals($receiver, AG$BlendEquation$SUBTRACT_getInstance()))
      return WebGLRenderingContext.FUNC_SUBTRACT;
    else if (equals($receiver, AG$BlendEquation$REVERSE_SUBTRACT_getInstance()))
      return WebGLRenderingContext.FUNC_REVERSE_SUBTRACT;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.toGl_1 = function ($receiver) {
    if (equals($receiver, AG$BlendFactor$DESTINATION_ALPHA_getInstance()))
      return WebGLRenderingContext.DST_ALPHA;
    else if (equals($receiver, AG$BlendFactor$DESTINATION_COLOR_getInstance()))
      return WebGLRenderingContext.DST_COLOR;
    else if (equals($receiver, AG$BlendFactor$ONE_getInstance()))
      return WebGLRenderingContext.ONE;
    else if (equals($receiver, AG$BlendFactor$ONE_MINUS_DESTINATION_ALPHA_getInstance()))
      return WebGLRenderingContext.ONE_MINUS_DST_ALPHA;
    else if (equals($receiver, AG$BlendFactor$ONE_MINUS_DESTINATION_COLOR_getInstance()))
      return WebGLRenderingContext.ONE_MINUS_DST_COLOR;
    else if (equals($receiver, AG$BlendFactor$ONE_MINUS_SOURCE_ALPHA_getInstance()))
      return WebGLRenderingContext.ONE_MINUS_SRC_ALPHA;
    else if (equals($receiver, AG$BlendFactor$ONE_MINUS_SOURCE_COLOR_getInstance()))
      return WebGLRenderingContext.ONE_MINUS_SRC_COLOR;
    else if (equals($receiver, AG$BlendFactor$SOURCE_ALPHA_getInstance()))
      return WebGLRenderingContext.SRC_ALPHA;
    else if (equals($receiver, AG$BlendFactor$SOURCE_COLOR_getInstance()))
      return WebGLRenderingContext.SRC_COLOR;
    else if (equals($receiver, AG$BlendFactor$ZERO_getInstance()))
      return WebGLRenderingContext.ZERO;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.toGl_j3v1aq$ = function ($receiver) {
    if (equals($receiver, AG$TriangleFace$FRONT_getInstance()))
      return WebGLRenderingContext.FRONT;
    else if (equals($receiver, AG$TriangleFace$BACK_getInstance()))
      return WebGLRenderingContext.BACK;
    else if (equals($receiver, AG$TriangleFace$FRONT_AND_BACK_getInstance()))
      return WebGLRenderingContext.FRONT_AND_BACK;
    else if (equals($receiver, AG$TriangleFace$NONE_getInstance()))
      return WebGLRenderingContext.FRONT;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.toGl_d0rqip$ = function ($receiver) {
    if (equals($receiver, AG$CompareMode$ALWAYS_getInstance()))
      return WebGLRenderingContext.ALWAYS;
    else if (equals($receiver, AG$CompareMode$EQUAL_getInstance()))
      return WebGLRenderingContext.EQUAL;
    else if (equals($receiver, AG$CompareMode$GREATER_getInstance()))
      return WebGLRenderingContext.GREATER;
    else if (equals($receiver, AG$CompareMode$GREATER_EQUAL_getInstance()))
      return WebGLRenderingContext.GEQUAL;
    else if (equals($receiver, AG$CompareMode$LESS_getInstance()))
      return WebGLRenderingContext.LESS;
    else if (equals($receiver, AG$CompareMode$LESS_EQUAL_getInstance()))
      return WebGLRenderingContext.LEQUAL;
    else if (equals($receiver, AG$CompareMode$NEVER_getInstance()))
      return WebGLRenderingContext.NEVER;
    else if (equals($receiver, AG$CompareMode$NOT_EQUAL_getInstance()))
      return WebGLRenderingContext.NOTEQUAL;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.toGl_7ptukq$ = function ($receiver) {
    if (equals($receiver, AG$StencilOp$DECREMENT_SATURATE_getInstance()))
      return WebGLRenderingContext.DECR;
    else if (equals($receiver, AG$StencilOp$DECREMENT_WRAP_getInstance()))
      return WebGLRenderingContext.DECR_WRAP;
    else if (equals($receiver, AG$StencilOp$INCREMENT_SATURATE_getInstance()))
      return WebGLRenderingContext.INCR;
    else if (equals($receiver, AG$StencilOp$INCREMENT_WRAP_getInstance()))
      return WebGLRenderingContext.INCR_WRAP;
    else if (equals($receiver, AG$StencilOp$INVERT_getInstance()))
      return WebGLRenderingContext.INVERT;
    else if (equals($receiver, AG$StencilOp$KEEP_getInstance()))
      return WebGLRenderingContext.KEEP;
    else if (equals($receiver, AG$StencilOp$SET_getInstance()))
      return WebGLRenderingContext.REPLACE;
    else if (equals($receiver, AG$StencilOp$ZERO_getInstance()))
      return WebGLRenderingContext.ZERO;
    else
      return Kotlin.noWhenBranchMatched();
  };
  AGWebgl.prototype.draw_n1yu8b$$default = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState) {
    ...
    (Kotlin.isType(tmp$ = vertices, AGWebgl$WebglBuffer) ? tmp$ : throwCCE()).bind();
    (Kotlin.isType(tmp$_0 = aindices, AGWebgl$WebglBuffer) ? tmp$_0 : throwCCE()).bind();
    glProgram.bind();
    ...
    while (tmp$_5.hasNext()) {
      ...
      tmp$_6 = glProgram.uniformLocation_2f4vi3$(uniform);
      if (tmp$_6 == null) {
        continue;
      }
      var location = tmp$_6;
      tmp$_7 = uniform.type;
      if (equals(tmp$_7, VarType$TextureUnit_getInstance())) {
        var unit = Kotlin.isType(tmp$_8 = value, AG$TextureUnit) ? tmp$_8 : throwCCE();
        this.gl.activeTexture(WebGLRenderingContext.TEXTURE0 + textureUnit | 0);
        var tex = (tmp$_9 = unit.texture) == null || Kotlin.isType(tmp$_9, AGWebgl$WebglTexture) ? tmp$_9 : throwCCE();
        tex != null ? (tex.bindEnsuring(), Unit) : null;
        tex != null ? (tex.setFilter_6taknv$(unit.linear), Unit) : null;
        this.gl.uniform1i(location, textureUnit);
        textureUnit = textureUnit + 1 | 0;
      }
       else if (equals(tmp$_7, VarType$Mat4_getInstance())) {
        this.glUniformMatrix4fv_0(location, false, (Kotlin.isType(tmp$_10 = value, Matrix4) ? tmp$_10 : throwCCE()).data);
      }
       else if (equals(tmp$_7, VarType$Float1_getInstance())) {
        this.gl.uniform1f(location, numberToDouble(Kotlin.isNumber(tmp$_11 = value) ? tmp$_11 : throwCCE()));
      }
       else
    ...
    this.gl.depthMask(renderState.depthMask);
    this.gl.depthRange(renderState.depthNear, renderState.depthFar);
    this.gl.lineWidth(renderState.lineWidth);
    if (renderState.depthFunc !== AG$CompareMode$ALWAYS_getInstance()) {
      ...
      this.gl.depthFunc(this.toGl_d0rqip$(renderState.depthFunc));
      var res_0 = Unit;
      if (this.checkErrors) {
    ...
    tmp$_12 = destination_0.iterator();
  ...
  AGWebgl.prototype.glUniformMatrix4fv_0 = function (location, b, values) {
    var tmp$;
    this.gl.uniformMatrix4fv(location, b, Kotlin.isType(tmp$ = values, Float32Array) ? tmp$ : throwCCE());
  };
  ...
  Object.defineProperty(AGWebgl$WebglRenderBuffer.prototype, 'wtex', {
    get: function () {
      var tmp$;
      return Kotlin.isType(tmp$ = this.tex, AGWebgl$WebglTexture) ? tmp$ : throwCCE();
    }
  });
  ...
  AGWebgl.prototype.readColor_59u9qz$ = function (bitmap) {
    this.gl.readPixels(0, 0, bitmap.width, bitmap.height, WebGLRenderingContext.RGBA, WebGLRenderingContext.UNSIGNED_BYTE, new Uint8Array(bitmap.data.buffer));
  };
  AGWebgl.prototype.readDepth_l5lmba$ = function (width, height, out) {
    this.gl.readPixels(0, 0, width, height, WebGLRenderingContext.DEPTH_COMPONENT, WebGLRenderingContext.FLOAT, out);
  };
  ...
  function AGWebgl_init$lambda_1(closure$event, this$AGWebgl) {
    return function (e) {
      closure$event.keyCode = e.keyCode;
      this$AGWebgl.agInput.onKeyDown.invoke_11rb$(closure$event);
      return Unit;
    };
  }
  function AGWebgl_init$lambda_2(closure$event, this$AGWebgl) {
    return function (e) {
      closure$event.keyCode = e.keyCode;
      this$AGWebgl.agInput.onKeyUp.invoke_11rb$(closure$event);
      return Unit;
    };
  }
  function AGWebgl_init$lambda_3(closure$event, this$AGWebgl) {
    return function (e) {
      closure$event.keyCode = e.keyCode;
      this$AGWebgl.agInput.onKeyTyped.invoke_11rb$(closure$event);
      return Unit;
    };
  }
  AGWebgl.$metadata$ = {
  ...
  Object.defineProperty(package$korag, 'KORAG_VERSION_8be2vx$', {
    get: function () {
  ...
  AGWebgl.MyUniformLocation = AGWebgl$MyUniformLocation;
