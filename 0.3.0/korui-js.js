(function (root, factory) {
  ...
  function HtmlLightComponents$addHandler$process(closure$info, this$HtmlLightComponents) {
    return function (e, buttons) {
      ...
      $receiver.x = numberToInt(numberToInt(e.offsetX) * this$HtmlLightComponents_0.devicePixelRatio);
      $receiver.y = numberToInt(numberToInt(e.offsetY) * this$HtmlLightComponents_0.devicePixelRatio);
  ...
  HtmlLightComponents.prototype.setProperty_qiitpl$ = function (c, key, value) {
    ...
    if (equals(key, LightProperty$Companion_getInstance().TEXT)) {
      ...
      if (v_4 != null) {
        ...
        if (link == null) {
          link = Kotlin.isType(tmp$_7 = document.createElement('link'), HTMLLinkElement) ? tmp$_7 : throwCCE();
        }
      ...
      (Kotlin.isType(tmp$_9 = child.querySelector('input[type=checkbox]'), HTMLInputElement) ? tmp$_9 : throwCCE()).checked = v_6;
    }
  };
