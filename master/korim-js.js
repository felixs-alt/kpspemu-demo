(function (root, factory) {
  ...
  var EOFException = $module$korio_js.com.soywiz.korio.EOFException;
  ...
  var ByteArrayBuilder_init = $module$korio_js.com.soywiz.korio.stream.ByteArrayBuilder_init;
  ...
  BitmapIndexed.prototype.setRow_5pgyc$ = function (y, row) {
    arraycopy(row.data, 0, this.data, this.index_vux9f0$(0, y), this.stride);
  };
  BitmapIndexed.prototype.setRow_3fbn1q$ = function (y, row) {
    arraycopy(row, 0, this.data, this.index_vux9f0$(0, y), this.stride);
  };
  ...
  BitmapIndexed.prototype.swapRows_vux9f0$ = function (y0, y1) {
    ...
    arraycopy(this.data, s0, this.temp, 0, this.stride);
    arraycopy(this.data, s1, this.data, s0, this.stride);
    arraycopy(this.temp, 0, this.data, s1, this.stride);
  };
  ...
  JPEG$JPEGDecoder.prototype.read_0 = function (buf, off, len) {
    ...
    while (l > 0) {
      ...
      arraycopy(this.inputBuffer_0, this.inputBufferPos_0, buf, o, copy);
      o = o + copy | 0;
      l = l - copy | 0;
  ...
  JPEG$JPEGDecoder.prototype.decodeBlock_0 = function (data, c) {
    ...
    data[0] = toShort(Kotlin.imul(dc, dq[0] & 255));
    var hac = c.huffAC;
    var k = 1;
    do {
      ...
      if (s !== 0) {
        ...
        data[JPEG$JPEGDecoder$Companion_getInstance().dezigzag_8be2vx$.charCodeAt(k) | 0] = toShort(v);
      }
       else if (rs !== 240) {
        break;
      }
  ...
  JPEG$JPEGDecoder.prototype.reset_0 = function () {
    ...
    this.nomore = false;
    this.marker_0 = JPEG$JPEGDecoder$Companion_getInstance().MARKER_NONE_8be2vx$;
    this.todo_0 = this.restartInterval_0 !== 0 ? this.restartInterval_0 : kotlin_js_internal_IntCompanionObject.MAX_VALUE;
  ...
  JPEG$JPEGDecoder.prototype.processMarker_0 = function (marker) {
    ...
    if (marker === JPEG$JPEGDecoder$Companion_getInstance().MARKER_NONE_8be2vx$)
      ...
      throw new IOException('Unknown marker: ' + toString(marker));
  };
  ...
  function JPEG$JPEGDecoder$Huffman(count, dummy) {
    ...
    for (var i = 0; i < 16; i++) {
      ...
      for (var j = 0; j < tmp$_0; j++) {
        $receiver[tmp$_1 = k, k = tmp$_1 + 1 | 0, tmp$_1] = toByte(i + 1 | 0);
      }
    }
    ...
    this.maxCode_8be2vx$[17] = kotlin_js_internal_IntCompanionObject.MAX_VALUE;
    var $receiver_0 = this.fast_8be2vx$;
    var value = toByte(-1);
    var end;
    end = $receiver_0.length;
    $receiver_0.fill(value, 0, end);
    var tmp$_4;
    tmp$_4 = k_0.v;
    for (var i_1 = 0; i_1 < tmp$_4; i_1++) {
      ...
      if (s <= JPEG$JPEGDecoder$Huffman$Companion_getInstance().FAST_BITS_8be2vx$) {
        ...
        for (var j_0 = 0; j_0 < m; j_0++)
          this.fast_8be2vx$[c_0 + j_0 | 0] = toByte(i_1);
      }
    }
  }
  ...
  JPEG$JPEGDecoder$IDCT_2D$Companion.prototype.clampShift17_0 = function (x) {
    return toByte(x < 0 ? 0 : x > 255 << 17 ? 255 : x >>> 17);
  };
  ...
  JPEG$JPEGDecoder$Companion.prototype.upsampleH2_0 = function (out, outPos, inp, inPos, width) {
    if (width === 1) {
      ...
      out[outPos] = toByte(i0);
      out[outPos + 1 | 0] = toByte((i0 * 3 | 0) + i1 + 2 >> 2);
      for (var i = 2; i < width; i++) {
        var i2 = inp[inPos + i | 0] & 255;
        var n = (i1 * 3 | 0) + 2 | 0;
        out[outPos + (i * 2 | 0) - 2 | 0] = toByte(n + i0 >> 2);
        out[outPos + (i * 2 | 0) - 1 | 0] = toByte(n + i2 >> 2);
        i0 = i1;
        i1 = i2;
      }
      out[outPos + (width * 2 | 0) - 2 | 0] = toByte((i0 * 3 | 0) + i1 + 2 >> 2);
      out[outPos + (width * 2 | 0) - 1 | 0] = toByte(i1);
    }
  };
  JPEG$JPEGDecoder$Companion.prototype.upsampleV2_0 = function (out, outPos, inp, inPos0, inPos1, width) {
    for (var i = 0; i < width; i++)
      out[outPos + i | 0] = toByte((3 * (inp[inPos0 + i | 0] & 255) | 0) + (inp[inPos1 + i | 0] & 255) + 2 >> 2);
  };
  JPEG$JPEGDecoder$Companion.prototype.upsampleHV2_0 = function (out, outPos, inp, inPos0, inPos1, width) {
    if (width === 1) {
      ...
      out[outPos] = toByte(i1_0 + 2 >> 2);
      for (var i = 1; i < width; i++) {
        var i0_0 = i1_0;
        i1_0 = (3 * (inp[inPos0 + i | 0] & 255) | 0) + (inp[inPos1 + i | 0] & 255) | 0;
        out[outPos + (i * 2 | 0) - 1 | 0] = toByte((3 * i0_0 | 0) + i1_0 + 8 >> 4);
        out[outPos + (i * 2 | 0) | 0] = toByte((3 * i1_0 | 0) + i0_0 + 8 >> 4);
      }
      out[outPos + (width * 2 | 0) - 1 | 0] = toByte(i1_0 + 2 >> 2);
    }
  };
    ...
    return function (data) {
      if (closure$level === 0) {
        ...
        for (var n = 0; n < blocks; n++) {
          ...
          arraycopy(data, upos, out, pos + 5 | 0, size);
          pos = pos + (5 + size) | 0;
          upos = upos + size | 0;
        }
  ...
  PNG.prototype.readCommon_0 = function (s, readHeader) {
    ...
    if (header.bytes === 1) {
      ...
      for (var y = 0; y < height; y++) {
        ...
        this.applyFilter_z7lxd8$(filter, lastRow, currentRow, header.bytes);
      ...
      for (var y_0 = 0; y_0 < height; y_0++) {
        ...
        readExact(data, currentRow.data, 0, stride);
        this.applyFilter_z7lxd8$(filter_0, lastRow, currentRow, header.bytes);
        tmp$_0 = header.bytes;
        if (tmp$_0 === 3)
  ...
  PNG.prototype.applyFilter_z7lxd8$ = function (filter, p, c, bpp) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    if (filter !== 0)
      if (filter === 1) {
        tmp$ = c.size;
