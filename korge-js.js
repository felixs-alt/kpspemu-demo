(function (root, factory) {
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(EventLoop), void 0, this);
            tmp$ = this.result_0;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(AG), void 0, this);
            tmp$_0 = this.result_0;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(AsyncInjector), void 0, this);
            tmp$_1 = this.result_0;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(Input), void 0, this);
            tmp$_2 = this.result_0;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(KorgePlugins), void 0, this);
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.local$injector.mapSingleton_wmmeli$(Views, Kotlin.isInstanceOf(Views), Korge$setupCanvas$lambda).mapSingleton_wmmeli$(Input, Kotlin.isInstanceOf(Input), Korge$setupCanvas$lambda_0).mapInstance_issdgt$(KorgePlugins, Kotlin.isInstanceOf(KorgePlugins), defaultKorgePlugins).mapPrototype_7g6y7r$(getKClass(EmptyScene), Korge$setupCanvas$lambda_1).mapSingleton_7g6y7r$(getKClass(ResourcesRoot), Korge$setupCanvas$lambda_2);
            ...
            if (this.local$config.trace)
              println('Korge.setupCanvas[1f]. size: ' + size);
            var instance = this.local$config.eventLoop;
            this.local$injector.mapInstance_b1ce0a$(getKClass(EventLoop), instance);
            this.result_0 = this.local$injector.get_esmw97$(getKClass(Views), void 0, this);
          ...
          case 5:
            ...
            var instance_0 = this.local$config.timeProvider;
            this.local$injector.mapInstance_b1ce0a$(getKClass(TimeProvider), instance_0);
            var instance_1 = this.local$config.module;
            this.local$injector.mapInstance_b1ce0a$(getKClass(Module), instance_1);
            this.state_0 = 6;
          ...
          case 6:
            ...
            var updateMousePos = Korge$setupCanvas$updateMousePos(this.local$container, this.local$views);
            var updateTouchPos = Korge$setupCanvas$updateTouchPos(this.local$container, this.local$views);
            if (this.local$config.trace)
            ...
            this.local$container.agInput.onMouseDown.invoke_qlkmfe$(Korge$setupCanvas$lambda_3(this.local$views, updateMousePos, downPos, mouseDownEvent));
            this.local$container.agInput.onMouseUp.invoke_qlkmfe$(Korge$setupCanvas$lambda_4(this.local$views, updateMousePos, upPos, mouseUpEvent));
            this.local$container.agInput.onMouseOver.invoke_qlkmfe$(Korge$setupCanvas$lambda_5(updateMousePos, this.local$views, mouseMovedEvent));
            this.local$container.agInput.onMouseClick.invoke_qlkmfe$(Korge$setupCanvas$lambda_6(updateMousePos, this.local$views, mouseClickEvent));
            var moveMouseOutsideInNextFrame = {v: false};
            this.local$container.agInput.onTouchStart.invoke_qlkmfe$(Korge$setupCanvas$lambda_7(this.local$views, updateTouchPos, downPos, mouseDownEvent));
            this.local$container.agInput.onTouchEnd.invoke_qlkmfe$(Korge$setupCanvas$lambda_8(this.local$views, updateTouchPos, upPos, mouseUpEvent, moveMouseOutsideInNextFrame));
            this.local$container.agInput.onTouchMove.invoke_qlkmfe$(Korge$setupCanvas$lambda_9(updateTouchPos, this.local$views, mouseMovedEvent));
            this.local$container.agInput.onKeyDown.invoke_qlkmfe$(Korge$setupCanvas$lambda_10(this.local$views, keyDownEvent, copyTo));
            this.local$container.agInput.onKeyUp.invoke_qlkmfe$(Korge$setupCanvas$lambda_11(this.local$views, keyUpEvent, copyTo));
            this.local$container.agInput.onKeyTyped.invoke_qlkmfe$(Korge$setupCanvas$lambda_12(keyTypedEvent, copyTo, this.local$views));
            ...
            this.local$ag.onRender.invoke_qlkmfe$(Korge$setupCanvas$lambda_14(this.local$config, lastTime, this.local$views, moveMouseOutsideInNextFrame, mouseMovedEvent));
            if (this.local$config.trace)
  ...
  Korge.prototype.invoke_lakzb2$ = function (module_0, args, container, sceneClass, sceneInjects, timeProvider, injector, debug, trace, constructedViews, eventLoop) {
    if (args === void 0)
      args = [];
    if (container === void 0)
      container = null;
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.getOrNull_esmw97$(getKClass(Path), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 1:
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = this.local$$receiver.getOrNull_esmw97$(getKClass(VPath), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 3:
            this.local$tmp$_0 = this.result_0;
            this.state_0 = 4;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(Views), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 4:
          ...
          case 5:
            ...
            this.state_0 = 6;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(ResourcesRoot), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 6:
  ...
  Coroutine$register_gohfjx$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$views.injector.mapFactory_7kvue$(getKClass(AnLibrary), AnLibraryPlugin$register$lambda);
            return;
          case 1:
            throw this.exception_0;
        }
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            this.state_0 = 4;
            this.result_0 = loader.invoke_yah46i$(new FastByteArrayInputStream(this.local$content), this.$this.injector, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 4:
  ...
  Coroutine$register_gohfjx$_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$views.injector.mapFactory_7kvue$(getKClass(Atlas), AtlasPlugin$register$lambda);
            return;
          case 1:
            throw this.exception_0;
        }
  ...
  var toLinkedMap = $module$korio_js.com.soywiz.korio.ds.toLinkedMap_6hr0sd$;
  ...
  AtlasInfo$Companion.prototype.loadJsonSpriter_61zpoe$ = function (json_0) {
    ...
    var mapper;
    mapper = serialization.Mapper;
    var info = $this.decodeToType_ye3lh8$(getKClass(AtlasInfo), json_0, mapper);
      ...
      try {
        switch (this.state_0) {
          ...
          case 4:
            this.local$tmp$_1 = this.result_0;
            this.state_0 = 5;
            this.result_0 = this.local$$receiver.get_esmw97$(getKClass(SoundSystem), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 5:
  ...
  Coroutine$register_gohfjx$_1.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$views.injector.mapFactory_7kvue$(getKClass(SoundFile), SoundPlugin$register$lambda);
            return;
          case 1:
            throw this.exception_0;
        }
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            this.local$tmp$_0 = this.result_0;
            this.state_0 = 4;
            this.result_0 = this.local$$receiver.getOrNull_esmw97$(getKClass(FontDescriptor), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 4:
  ...
  Coroutine$register_gohfjx$_2.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$views.injector.mapFactory_7kvue$(getKClass(BitmapFont), BitmapFontPlugin$register$lambda);
            return;
          case 1:
            throw this.exception_0;
        }
      ...
      try {
        switch (this.state_0) {
          ...
          case 5:
            ...
            var tmp$_4 = toMap(destination_1);
            var destination_2 = ArrayList_init_0(collectionSizeOrDefault(kernings, 10));
            var tmp$_5;
            tmp$_5 = kernings.iterator();
            while (tmp$_5.hasNext()) {
              var item_2 = tmp$_5.next();
              destination_2.add_11rb$(to(to(item_2.first, item_2.second), item_2));
            }

            return new BitmapFont(this.local$ag, this.local$fontSize, tmp$_4, toMap(destination_2));
        }
      }
       catch (e) {
        if (this.state_0 === 1)
  ...
  Object.defineProperty(Html$Format.prototype, 'computedColor', {
    get: function () {
      return this.computedColor_lhqqal$_0.getValue_7w76kw$(this, new PropertyMetadata('computedColor'));
    }
  });
  Object.defineProperty(Html$Format.prototype, 'computedFace', {
    get: function () {
      return this.computedFace_asvglt$_0.getValue_7w76kw$(this, new PropertyMetadata('computedFace'));
    }
  });
  Object.defineProperty(Html$Format.prototype, 'computedSize', {
    get: function () {
      return this.computedSize_b06d9p$_0.getValue_7w76kw$(this, new PropertyMetadata('computedSize'));
    }
  });
  Object.defineProperty(Html$Format.prototype, 'computedLetterSpacing', {
    get: function () {
      return this.computedLetterSpacing_9ivxe1$_0.getValue_7w76kw$(this, new PropertyMetadata('computedLetterSpacing'));
    }
  });
  Object.defineProperty(Html$Format.prototype, 'computedKerning', {
    get: function () {
      return this.computedKerning_uyqaje$_0.getValue_7w76kw$(this, new PropertyMetadata('computedKerning'));
    }
  });
  Object.defineProperty(Html$Format.prototype, 'computedAlign', {
    get: function () {
      return this.computedAlign_mhjfun$_0.getValue_7w76kw$(this, new PropertyMetadata('computedAlign'));
    }
  });
  ...
  function MouseComponent(view) {
    ...
    this.clickedCount = 0;
    var tmp$ = this.detatchCancellables;
    var element = this.view.addEventListener_8bdrlz$(getKClass(MouseClickEvent), MouseComponent_init$lambda(this));
    tmp$.add_11rb$(element);
    var tmp$_0 = this.detatchCancellables;
  ...
  function BatchBuilder2D(ag, maxQuads) {
    ...
    this.vertices_0 = KorioNative$FastMemory.Companion.alloc_za3lpa$(Kotlin.imul(6 * 4 | 0, this.maxVertices));
    this.indices_0 = KorioNative$FastMemory.Companion.alloc_za3lpa$(2 * this.maxIndices | 0);
  ...
  BatchBuilder2D.prototype.flush = function () {
    ...
    if (this.vertexCount_0 > 0) {
      ...
      this.vertexBuffer_0.upload_pcjvbk$(this.vertices_0, 0, this.vertexPos_0 * 4 | 0);
      this.indexBuffer_0.upload_pcjvbk$(this.indices_0, 0, this.indexPos_0 * 2 | 0);
      tmp$_6 = this.ag;
  ...
  defineInlineFunction('korge-js.com.soywiz.korge.resources.getPath_zehwnb$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = this.local$injector.get_esmw97$(getKClass(SceneContainer), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 3:
            ...
            this.state_0 = 4;
            this.result_0 = this.local$injector.get_esmw97$(getKClass(ResourcesRoot), void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 4:
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.result_0 = this.local$injector.get_esmw97$(getKClass(Logger), void 0, this);
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = sceneInjector.get_esmw97$(this.local$clazz, void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 1:
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            if (bounds.area <= 0.0)
              return false;
            this.result_0 = this.$this.injector.get_esmw97$(getKClass(Module), void 0, this);
  ...
  Container.prototype.dispatch_gdt21f$$default = function (event, clazz) {
    ...
    var n = 0;
    while (n < this.children.size) {
      Container$dispatch$lambda(event, clazz)(this.children.get_za3lpa$(n));
      n = n + 1 | 0;
    }
  };
  ...
  Text.prototype.render_edjgwy$ = function (ctx, m) {
    ...
    if (this.document != null) {
      ...
      font_0.drawText_5nrand$(ctx.batch, this.format.computedSize, this.text, numberToInt(x), numberToInt(y), m, color.RGBA.multiply_vux9f0$(colorMul, this.format.computedColor), colorAdd, this.computedBlendMode);
    }
  };
  ...
  function text($receiver, text, textSize, color_0, font) {
    ...
    $receiver_0.format.size = numberToInt(textSize);
    if (!equals(text, ''))
  ...
  View.prototype.toString = function () {
    var out = Kotlin.getKClassFromExpression(this).toString() + '(' + this.id + ')';
  ...
  function Views(eventLoop, ag, injector, input, plugins) {
    ...
    $this.mapInstance_b1ce0a$(getKClass(EventLoop), instance);
    var $this_0 = this.injector;
    var instance_0 = this.ag;
    $this_0.mapInstance_b1ce0a$(getKClass(AG), instance_0);
    this.injector.mapInstance_b1ce0a$(getKClass(Views), this);
    var $this_1 = this.injector;
    var instance_1 = get_soundSystem(this);
    $this_1.mapInstance_b1ce0a$(getKClass(SoundSystem), instance_1);
