(function (root, factory) {
      ...
      case 16:
        if (littleEndian) {
          ...
          for (var n = 0; n < size; n++) {
            ...
            io = io + bytesPerPixel | 0;
            out[tmp$ = oo, oo = tmp$ + 1 | 0, tmp$] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c), this.getG_za3lpa$(c), this.getB_za3lpa$(c), this.getA_za3lpa$(c));
          }
        }
         else {
          var tmp$_0;
          ...
          for (var n_0 = 0; n_0 < size; n_0++) {
            ...
            out[tmp$_0 = oo_0, oo_0 = tmp$_0 + 1 | 0, tmp$_0] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c_0), this.getG_za3lpa$(c_0), this.getB_za3lpa$(c_0), this.getA_za3lpa$(c_0));
          }
        }
      ...
      case 24:
        if (littleEndian) {
          ...
          for (var n_1 = 0; n_1 < size; n_1++) {
            ...
            out[tmp$_1 = oo_1, oo_1 = tmp$_1 + 1 | 0, tmp$_1] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c_1), this.getG_za3lpa$(c_1), this.getB_za3lpa$(c_1), this.getA_za3lpa$(c_1));
          }
        }
         else {
          var tmp$_2;
          ...
          for (var n_2 = 0; n_2 < size; n_2++) {
            ...
            out[tmp$_2 = oo_2, oo_2 = tmp$_2 + 1 | 0, tmp$_2] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c_2), this.getG_za3lpa$(c_2), this.getB_za3lpa$(c_2), this.getA_za3lpa$(c_2));
          }
        }
      ...
      case 32:
        if (littleEndian) {
          ...
          for (var n_3 = 0; n_3 < size; n_3++) {
            ...
            out[tmp$_3 = oo_3, oo_3 = tmp$_3 + 1 | 0, tmp$_3] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c_3), this.getG_za3lpa$(c_3), this.getB_za3lpa$(c_3), this.getA_za3lpa$(c_3));
          }
        }
         else {
          var tmp$_4;
          ...
          for (var n_4 = 0; n_4 < size; n_4++) {
            ...
            out[tmp$_4 = oo_4, oo_4 = tmp$_4 + 1 | 0, tmp$_4] = package$color.RGBA.packFast_tjonv8$(this.getR_za3lpa$(c_4), this.getG_za3lpa$(c_4), this.getB_za3lpa$(c_4), this.getA_za3lpa$(c_4));
          }
        }
  ...
  NamedColors.prototype.get_bm4lxs$ = function (str, default_0) {
    ...
    if (startsWith(str, '#')) {
      ...
      return (tmp$ = this.colorsByName.get_11rb$(str.toLowerCase())) != null ? tmp$ : default_0;
    }
  };
  ...
  RGBA.prototype.mix_vux9f0$ = function (dst, src) {
    ...
    switch (srcA) {
      ...
      case 255:
        tmp$ = src;
        break;
      default:tmp$ = RGBA_getInstance().packRGB_A_vux9f0$(this.blendRGB_qt1dr2$(dst, src, srcA + 1 | 0), ColorFormat$Companion_getInstance().clampFF_za3lpa$(RGBA_getInstance().getFastA_za3lpa$(dst) + srcA | 0));
        break;
    }
    return tmp$;
  };
    ...
    if ((tmp$ = this.openTable_61zpoe$('loca')) != null) {
      ...
      switch (this.indexToLocFormat) {
        ...
        case 1:
          tmp$_1 = 4;
          break;
        default:tmp$_1 = error.invalidOp;
          break;
      }
      var bytesPerEntry = tmp$_1;
      ...
      switch (this.indexToLocFormat) {
        ...
        case 1:
          var tmp$_3;
          tmp$_3 = this.locs;
          for (var n_0 = 0; n_0 !== tmp$_3.length; ++n_0) {
  ...
  DDS.prototype.get_fourcc_qovqgb$ = function ($receiver) {
    ...
    getValue_jvq2vc$break: do {
      ...
      if (res == null) {
        ...
        tmp$_4 = (tmp$_3 = $this.name) != null ? tmp$_3 : DDS$fourcc_metadata.callableName;
  ...
  ImageFormats.prototype.readImage_1ooaqm$$default = function (s, props) {
    ...
    throw UnsupportedOperationException_init('Not suitable image format : MAGIC:' + readString(slice(s), 4, lang.ASCII) + '(' + get_hexString(readBytes(slice(s), 4)) + ') (' + toString_0(readBytes(slice(s), 4), lang.ASCII) + ')');
  };
  ...
  PNG.prototype.readCommon_0 = function (s, readHeader) {
    ...
    if (readS32_be_0(s) !== this.MAGIC1)
      throw IllegalArgumentException_init('Invalid PNG file');
    readS32_be_0(s);
    var pheader = {v: null};
    ...
    block$break: do {
      switch ($receiver.getType().name) {
        ...
        case 'SCALE_TRANSLATE':
          ...
          break block$break;
        default:block$result = 'matrix(' + get_niceStr_1($receiver.a) + ', ' + get_niceStr_1($receiver.b) + ', ' + get_niceStr_1($receiver.c) + ', ' + get_niceStr_1($receiver.d) + ', ' + get_niceStr_1($receiver.tx) + ', ' + get_niceStr_1($receiver.ty) + ')';
          break block$break;
      }
    }
     while (false);
  ...
  Object.defineProperty(NativeImageSpecialReader.prototype, 'instance', {
    get: function () {
      return this.instance_os49up$_0.value;
    }
  });
  ...
  function NativeImageFormatProvider$BrowserImage$loadImage$lambda$lambda_2(closure$c) {
    return function (f, f_0, f_1, f_2, f_3) {
      closure$c.resumeWithException_tcv7n7$(RuntimeException_init('error loading image'));
      return Unit;
    };
  }
  ...
  NativeImageFormatProvider$BrowserImage.prototype.loadImage_61zpoe$ = function (jsUrl_0, continuation_0, suspended) {
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda(_korioSuspendCoroutine$lambda(korioSuspendCoroutine$lambda(NativeImageFormatProvider$BrowserImage$loadImage$lambda(this.local$jsUrl))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  CanvasContext2dRenderer.prototype.toJsStr_2y61xz$ = function ($receiver) {
    ...
    if (Kotlin.isType($receiver, Context2d$None))
      ...
      tmp$_1 = NamedColors_getInstance().toHtmlStringSimple_za3lpa$($receiver.color);
