(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'korio-js', 'kds-js', 'korim-js', 'korma-js', 'korag-js', 'kmem-js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('korio-js'), require('kds-js'), require('korim-js'), require('korma-js'), require('korag-js'), require('kmem-js'));
  else {
    ...
    root['korui-js'] = factory(typeof this['korui-js'] === 'undefined' ? {} : this['korui-js'], kotlin, this['korio-js'], this['kds-js'], this['korim-js'], this['korma-js'], this['korag-js'], this['kmem-js']);
  }
}(this, function (_, Kotlin, $module$korio_js, $module$kds_js, $module$korim_js, $module$korma_js, $module$korag_js, $module$kmem_js) {
  'use strict';
  ...
  function Application_0(coroutineContext, light) {
    ...
    get_eventLoop(this.coroutineContext).animationFrameLoop_o14v8n$(Application_init$lambda(this));
  }
  function Application_init$lambda(this$Application) {
    return function () {
      var tmp$;
      var n = 0;
      while (n < this$Application.frames.size) {
        var frame = this$Application.frames.get_za3lpa$((tmp$ = n, n = tmp$ + 1 | 0, tmp$));
        if (frame.valid)
          continue;
        frame.setBoundsAndRelayout_t9mhyo$(frame.actualBounds);
        this$Application.light.repaint_za3rmp$(frame.handle);
      }
      return Unit;
    };
  }
  ...
  function frame$lambda($receiver, continuation_0, suspended) {
    var instance = new Coroutine$frame$lambda($receiver, this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$frame$lambda($receiver, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            var $receiver = new Frame(this.local$$receiver, this.local$title);
            $receiver.setBoundsInternal_tjonv8$(0, 0, this.local$width, this.local$height);
            this.local$frame = $receiver;
  ...
  function CanvasApplication$lambda(it, continuation_0, suspended) {
    var instance = new Coroutine$CanvasApplication$lambda(it, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$CanvasApplication$lambda(it, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            $receiver.focus();
            this.state_0 = 2;
            this.result_0 = tmp$($receiver, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Length$Companion.prototype.calc_keb01c$ = function (ctx, default_0, size, min, max, ignoreBounds) {
    ...
    var minCalc = calcMin(min, ctx, ignoreBounds ? kotlin_js_internal_IntCompanionObject.MIN_VALUE : 0);
    var maxCalc = calcMax(max, ctx, ignoreBounds ? kotlin_js_internal_IntCompanionObject.MAX_VALUE : ctx.size);
  ...
  function get_ag($receiver) {
    ...
    return (tmp$_1 = (tmp$_0 = (tmp$ = $receiver.extra) != null ? tmp$.get_11rb$(ag.name) : null) == null || Kotlin.isType(tmp$_0, Any) ? tmp$_0 : throwCCE()) != null ? tmp$_1 : ag.default;
  }
  ...
  function set_ag($receiver, ag_0) {
    ...
    tmp$ = ag.name;
    tmp$_1 = (tmp$_0 = ag_0) == null || Kotlin.isType(tmp$_0, Any) ? tmp$_0 : throwCCE();
    if (tmp$_2 != null) {
  ...
  AgCanvas.prototype.updateMouse_0 = function (e) {
    var $receiver = this.agInput.mouseEvent;
    $receiver.x = e.x;
    $receiver.y = e.y;
  };
  ...
  function button_0($receiver, text, callback, continuation, suspended) {
    var instance = new Coroutine$button($receiver, text, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$button($receiver, text, callback, continuation) {
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.button_7vtrb7$', wrapFunction(function () {
    var Button_init = _.com.soywiz.korui.ui.Button;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, text, callback, continuation) {
      var $receiver_1 = new Button_init($receiver.app, text);
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function progress($receiver_0, current_0, max_0, continuation) {
    return $receiver_0.add_x0aukp$(new Progress_init($receiver_0.app, current_0, max_0));
  }
  defineInlineFunction('korui-js.com.soywiz.korui.ui.progress_rtqiw6$', wrapFunction(function () {
    var Progress_init = _.com.soywiz.korui.ui.Progress;
    return function ($receiver_0, current_0, max_0, continuation) {
      return $receiver_0.add_x0aukp$(new Progress_init($receiver_0.app, current_0, max_0));
    };
  }));
  ...
  function image($receiver, bitmap, callback, continuation, suspended) {
    var instance = new Coroutine$image($receiver, bitmap, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$image($receiver, bitmap, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
    this.local$bitmap = bitmap;
    this.local$callback = callback;
  }
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.image_uhrqwu$', wrapFunction(function () {
    var Image_init = _.com.soywiz.korui.ui.Image;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, bitmap, callback, continuation) {
      var $receiver_1 = new Image_init($receiver.app);
      $receiver_1.image = bitmap;
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function image_0($receiver_0, bitmap_0, continuation) {
    var $receiver_0 = new Image_init($receiver_0.app);
    $receiver_0.image = bitmap_0;
    $receiver_0.style.defaultSize.width = get_pt(bitmap_0.width);
    $receiver_0.style.defaultSize.height = get_pt(bitmap_0.height);
    return $receiver_0.add_x0aukp$($receiver_0);
  }
  defineInlineFunction('korui-js.com.soywiz.korui.ui.image_wfl2m6$', wrapFunction(function () {
    var Image_init = _.com.soywiz.korui.ui.Image;
    var get_pt = _.com.soywiz.korui.geom.len.get_pt_s8ev3n$;
    return function ($receiver_0, bitmap_0, continuation) {
      var $receiver_1 = new Image_init($receiver_0.app);
      $receiver_1.image = bitmap_0;
      $receiver_1.style.defaultSize.width = get_pt(bitmap_0.width);
      $receiver_1.style.defaultSize.height = get_pt(bitmap_0.height);
      return $receiver_0.add_x0aukp$($receiver_1);
    };
  }));
  function spacer($receiver_0, continuation) {
    return $receiver_0.add_x0aukp$(new Spacer_init($receiver_0.app));
  }
  defineInlineFunction('korui-js.com.soywiz.korui.ui.spacer_r5smt6$', wrapFunction(function () {
    var Spacer_init = _.com.soywiz.korui.ui.Spacer;
    return function ($receiver_0, continuation) {
      return $receiver_0.add_x0aukp$(new Spacer_init($receiver_0.app));
    };
  }));
  function label($receiver, text, callback, continuation, suspended) {
    var instance = new Coroutine$label($receiver, text, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$label($receiver, text, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.label_dplrmp$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var Label_init = _.com.soywiz.korui.ui.Label;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    function label$lambda($receiver, continuation_0, suspended) {
      var instance = new Coroutine$label$lambda($receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
    }
    function Coroutine$label$lambda($receiver, controller, continuation_0) {
      CoroutineImpl.call(this, continuation_0);
      this.$controller = controller;
      this.exceptionState_0 = 1;
    }
    Coroutine$label$lambda.$metadata$ = {
      kind: Kotlin.Kind.CLASS,
      simpleName: null,
      interfaces: [CoroutineImpl]
    };
    Coroutine$label$lambda.prototype = Object.create(CoroutineImpl.prototype);
    Coroutine$label$lambda.prototype.constructor = Coroutine$label$lambda;
    Coroutine$label$lambda.prototype.doResume = function () {
      do
        try {
          switch (this.state_0) {
            case 0:
    ...
    return function ($receiver, text, callback, continuation) {
      ...
      var $receiver_1 = new Label_init($receiver.app, text);
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function checkBox($receiver, text, checked, callback, continuation, suspended) {
    var instance = new Coroutine$checkBox($receiver, text, checked, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$checkBox($receiver, text, checked, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.checkBox_7v3y9x$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var CheckBox_init = _.com.soywiz.korui.ui.CheckBox;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    function checkBox$lambda($receiver, continuation_0, suspended) {
      var instance = new Coroutine$checkBox$lambda($receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
    }
    function Coroutine$checkBox$lambda($receiver, controller, continuation_0) {
      CoroutineImpl.call(this, continuation_0);
      this.$controller = controller;
      this.exceptionState_0 = 1;
    }
    Coroutine$checkBox$lambda.$metadata$ = {
      kind: Kotlin.Kind.CLASS,
      simpleName: null,
      interfaces: [CoroutineImpl]
    };
    Coroutine$checkBox$lambda.prototype = Object.create(CoroutineImpl.prototype);
    Coroutine$checkBox$lambda.prototype.constructor = Coroutine$checkBox$lambda;
    Coroutine$checkBox$lambda.prototype.doResume = function () {
      do
        try {
          switch (this.state_0) {
            case 0:
    ...
    return function ($receiver, text, checked, callback, continuation) {
      if (checked === void 0)
        checked = false;
      if (callback === void 0)
        callback = checkBox$lambda;
      var $receiver_1 = new CheckBox_init($receiver.app, text, checked);
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function textField($receiver, text, callback, continuation, suspended) {
    var instance = new Coroutine$textField($receiver, text, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$textField($receiver, text, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.textField_2m75bu$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var TextField_init = _.com.soywiz.korui.ui.TextField;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    function textField$lambda($receiver, continuation_0, suspended) {
      var instance = new Coroutine$textField$lambda($receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
    }
    function Coroutine$textField$lambda($receiver, controller, continuation_0) {
      CoroutineImpl.call(this, continuation_0);
      this.$controller = controller;
      this.exceptionState_0 = 1;
    }
    Coroutine$textField$lambda.$metadata$ = {
      kind: Kotlin.Kind.CLASS,
      simpleName: null,
      interfaces: [CoroutineImpl]
    };
    Coroutine$textField$lambda.prototype = Object.create(CoroutineImpl.prototype);
    Coroutine$textField$lambda.prototype.constructor = Coroutine$textField$lambda;
    Coroutine$textField$lambda.prototype.doResume = function () {
      do
        try {
          switch (this.state_0) {
            case 0:
    ...
    return function ($receiver, text, callback, continuation) {
      ...
      var $receiver_1 = new TextField_init($receiver.app, text);
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function textArea($receiver, text, callback, continuation, suspended) {
    var instance = new Coroutine$textArea($receiver, text, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$textArea($receiver, text, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.textArea_kqtko5$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var TextArea_init = _.com.soywiz.korui.ui.TextArea;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    function textArea$lambda($receiver, continuation_0, suspended) {
      var instance = new Coroutine$textArea$lambda($receiver, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
    }
    function Coroutine$textArea$lambda($receiver, controller, continuation_0) {
      CoroutineImpl.call(this, continuation_0);
      this.$controller = controller;
      this.exceptionState_0 = 1;
    }
    Coroutine$textArea$lambda.$metadata$ = {
      kind: Kotlin.Kind.CLASS,
      simpleName: null,
      interfaces: [CoroutineImpl]
    };
    Coroutine$textArea$lambda.prototype = Object.create(CoroutineImpl.prototype);
    Coroutine$textArea$lambda.prototype.constructor = Coroutine$textArea$lambda;
    Coroutine$textArea$lambda.prototype.doResume = function () {
      do
        try {
          switch (this.state_0) {
            case 0:
    ...
    return function ($receiver, text, callback, continuation) {
      ...
      var $receiver_1 = new TextArea_init($receiver.app, text);
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function layers($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$layers($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$layers($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.layers_e5qoxs$', wrapFunction(function () {
    ...
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new Container_init($receiver.app, new LayeredLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function layersKeepAspectRatio($receiver, anchor, scaleMode, callback, continuation, suspended) {
    var instance = new Coroutine$layersKeepAspectRatio($receiver, anchor, scaleMode, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$layersKeepAspectRatio($receiver, anchor, scaleMode, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
    this.local$anchor = anchor;
    this.local$scaleMode = scaleMode;
    this.local$callback = callback;
  }
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.layersKeepAspectRatio_hhp93e$', wrapFunction(function () {
    ...
    var Container_init = _.com.soywiz.korui.ui.Container;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, anchor, scaleMode, callback, continuation) {
      if (anchor === void 0)
        anchor = Anchor.Companion.MIDDLE_CENTER;
      if (scaleMode === void 0)
        scaleMode = ScaleMode.Companion.SHOW_ALL;
      var $receiver_1 = new Container_init($receiver.app, new LayeredKeepAspectLayout_init($receiver.app, anchor, scaleMode));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function vertical($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$vertical($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$vertical($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.vertical_e5qoxs$', wrapFunction(function () {
    var VerticalLayout_init = _.com.soywiz.korui.ui.VerticalLayout;
    var Container_init = _.com.soywiz.korui.ui.Container;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new Container_init($receiver.app, new VerticalLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function horizontal($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$horizontal($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$horizontal($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.horizontal_e5qoxs$', wrapFunction(function () {
    var HorizontalLayout_init = _.com.soywiz.korui.ui.HorizontalLayout;
    var Container_init = _.com.soywiz.korui.ui.Container;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new Container_init($receiver.app, new HorizontalLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function inline($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$inline($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$inline($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.inline_e5qoxs$', wrapFunction(function () {
    var InlineLayout_init = _.com.soywiz.korui.ui.InlineLayout;
    var Container_init = _.com.soywiz.korui.ui.Container;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new Container_init($receiver.app, new InlineLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function relative($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$relative($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$relative($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.relative_e5qoxs$', wrapFunction(function () {
    var RelativeLayout_init = _.com.soywiz.korui.ui.RelativeLayout;
    var Container_init = _.com.soywiz.korui.ui.Container;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new Container_init($receiver.app, new RelativeLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  function scrollPane($receiver, callback, continuation, suspended) {
    var instance = new Coroutine$scrollPane($receiver, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$scrollPane($receiver, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.scrollPane_rf9v0u$', wrapFunction(function () {
    var ScrollPaneLayout_init = _.com.soywiz.korui.ui.ScrollPaneLayout;
    var ScrollPane_init = _.com.soywiz.korui.ui.ScrollPane;
    var await_0 = _.$$importsForInline$$['korio-js'].com.soywiz.korio.async.await_7zc599$;
    return function ($receiver, callback, continuation) {
      var $receiver_1 = new ScrollPane_init($receiver.app, new ScrollPaneLayout_init($receiver.app));
      Kotlin.suspendCall(await_0(callback, $receiver_1, Kotlin.coroutineReceiver()));
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  ...
  var mouseEventOnce;
  var mouseEventOnce_metadata = new PropertyMetadata('mouseEventOnce');
  function get_mouseEventOnce($receiver) {
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = mouseEventOnce.name) != null ? tmp$ : mouseEventOnce_metadata.callableName;
      ...
      if (res == null) {
        ...
        tmp$_4 = (tmp$_3 = mouseEventOnce.name) != null ? tmp$_3 : mouseEventOnce_metadata.callableName;
  ...
  function set_mouseEventOnce($receiver, mouseEventOnce_0) {
    ...
    tmp$_0 = (tmp$ = mouseEventOnce.name) != null ? tmp$ : mouseEventOnce_metadata.callableName;
    tmp$_2 = (tmp$_1 = mouseEventOnce_0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
    if (tmp$_3 != null) {
  ...
  var keyEventOnce;
  var keyEventOnce_metadata = new PropertyMetadata('keyEventOnce');
  function get_keyEventOnce($receiver) {
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = keyEventOnce.name) != null ? tmp$ : keyEventOnce_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = keyEventOnce.name) != null ? tmp$_3 : keyEventOnce_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  function set_keyEventOnce($receiver, keyEventOnce_0) {
    ...
    tmp$_3 = $receiver.extra;
    tmp$_0 = (tmp$ = keyEventOnce.name) != null ? tmp$ : keyEventOnce_metadata.callableName;
    tmp$_2 = (tmp$_1 = keyEventOnce_0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
    if (tmp$_3 != null) {
      tmp$_3.put_xwzc9p$(tmp$_0, tmp$_2);
    }
  }
  ...
  var touchEventOnce;
  var touchEventOnce_metadata = new PropertyMetadata('touchEventOnce');
  function get_touchEventOnce($receiver) {
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = touchEventOnce.name) != null ? tmp$ : touchEventOnce_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = touchEventOnce.name) != null ? tmp$_3 : touchEventOnce_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  function set_touchEventOnce($receiver, touchEventOnce_0) {
    ...
    tmp$_3 = $receiver.extra;
    tmp$_0 = (tmp$ = touchEventOnce.name) != null ? tmp$ : touchEventOnce_metadata.callableName;
    tmp$_2 = (tmp$_1 = touchEventOnce_0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
    if (tmp$_3 != null) {
      tmp$_3.put_xwzc9p$(tmp$_0, tmp$_2);
    }
  }
  ...
  var gamepadEventOnce_metadata = new PropertyMetadata('gamepadEventOnce');
  function get_gamepadEventOnce($receiver) {
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = gamepadEventOnce.name) != null ? tmp$ : gamepadEventOnce_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = gamepadEventOnce.name) != null ? tmp$_3 : gamepadEventOnce_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  function set_gamepadEventOnce($receiver, gamepadEventOnce_0) {
    ...
    tmp$_3 = $receiver.extra;
    tmp$_0 = (tmp$ = gamepadEventOnce.name) != null ? tmp$ : gamepadEventOnce_metadata.callableName;
    tmp$_2 = (tmp$_1 = gamepadEventOnce_0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
    if (tmp$_3 != null) {
      tmp$_3.put_xwzc9p$(tmp$_0, tmp$_2);
    }
  }
  ...
  var changeEventOnce;
  var changeEventOnce_metadata = new PropertyMetadata('changeEventOnce');
  function get_changeEventOnce($receiver) {
    var getValue_jvq2vc$result;
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = changeEventOnce.name) != null ? tmp$ : changeEventOnce_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = changeEventOnce.name) != null ? tmp$_3 : changeEventOnce_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  function set_changeEventOnce($receiver, changeEventOnce_0) {
    ...
    tmp$_3 = $receiver.extra;
    tmp$_0 = (tmp$ = changeEventOnce.name) != null ? tmp$ : changeEventOnce_metadata.callableName;
    tmp$_2 = (tmp$_1 = changeEventOnce_0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
    if (tmp$_3 != null) {
      tmp$_3.put_xwzc9p$(tmp$_0, tmp$_2);
    }
  }
  ...
  var onMouseUp;
  var onMouseUp_metadata = new PropertyMetadata('onMouseUp');
  function get_onMouseUp($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseUp.name) != null ? tmp$ : onMouseUp_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseUp.name) != null ? tmp$_3 : onMouseUp_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onMouseDown;
  var onMouseDown_metadata = new PropertyMetadata('onMouseDown');
  function get_onMouseDown($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseDown.name) != null ? tmp$ : onMouseDown_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseDown.name) != null ? tmp$_3 : onMouseDown_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onMouseClick;
  var onMouseClick_metadata = new PropertyMetadata('onMouseClick');
  function get_onMouseClick($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseClick.name) != null ? tmp$ : onMouseClick_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseClick.name) != null ? tmp$_3 : onMouseClick_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onMouseOver;
  var onMouseOver_metadata = new PropertyMetadata('onMouseOver');
  function get_onMouseOver($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseOver.name) != null ? tmp$ : onMouseOver_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseOver.name) != null ? tmp$_3 : onMouseOver_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onMouseEnter;
  var onMouseEnter_metadata = new PropertyMetadata('onMouseEnter');
  function get_onMouseEnter($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseEnter.name) != null ? tmp$ : onMouseEnter_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseEnter.name) != null ? tmp$_3 : onMouseEnter_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onMouseExit;
  var onMouseExit_metadata = new PropertyMetadata('onMouseExit');
  function get_onMouseExit($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onMouseExit.name) != null ? tmp$ : onMouseExit_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onMouseExit.name) != null ? tmp$_3 : onMouseExit_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onKeyTyped;
  var onKeyTyped_metadata = new PropertyMetadata('onKeyTyped');
  function get_onKeyTyped($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onKeyTyped.name) != null ? tmp$ : onKeyTyped_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onKeyTyped.name) != null ? tmp$_3 : onKeyTyped_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onKeyDown;
  var onKeyDown_metadata = new PropertyMetadata('onKeyDown');
  function get_onKeyDown($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onKeyDown.name) != null ? tmp$ : onKeyDown_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onKeyDown.name) != null ? tmp$_3 : onKeyDown_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onKeyUp;
  var onKeyUp_metadata = new PropertyMetadata('onKeyUp');
  function get_onKeyUp($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onKeyUp.name) != null ? tmp$ : onKeyUp_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onKeyUp.name) != null ? tmp$_3 : onKeyUp_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onTouchStart;
  var onTouchStart_metadata = new PropertyMetadata('onTouchStart');
  function get_onTouchStart($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onTouchStart.name) != null ? tmp$ : onTouchStart_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onTouchStart.name) != null ? tmp$_3 : onTouchStart_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onTouchEnd;
  var onTouchEnd_metadata = new PropertyMetadata('onTouchEnd');
  function get_onTouchEnd($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onTouchEnd.name) != null ? tmp$ : onTouchEnd_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onTouchEnd.name) != null ? tmp$_3 : onTouchEnd_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onTouchMove;
  var onTouchMove_metadata = new PropertyMetadata('onTouchMove');
  function get_onTouchMove($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onTouchMove.name) != null ? tmp$ : onTouchMove_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onTouchMove.name) != null ? tmp$_3 : onTouchMove_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onGamepadDown;
  var onGamepadDown_metadata = new PropertyMetadata('onGamepadDown');
  function get_onGamepadDown($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onGamepadDown.name) != null ? tmp$ : onGamepadDown_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onGamepadDown.name) != null ? tmp$_3 : onGamepadDown_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onGamepadUp;
  var onGamepadUp_metadata = new PropertyMetadata('onGamepadUp');
  function get_onGamepadUp($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onGamepadUp.name) != null ? tmp$ : onGamepadUp_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onGamepadUp.name) != null ? tmp$_3 : onGamepadUp_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var onChange;
  var onChange_metadata = new PropertyMetadata('onChange');
  function get_onChange($receiver) {
    var getValue_e5fciw$result;
    getValue_e5fciw$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = onChange.name) != null ? tmp$ : onChange_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = onChange.name) != null ? tmp$_3 : onChange_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = this.local$$receiver_0.setVector_qmzsv0$(this.local$vector, this.local$vector.width, this.local$vector.height, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function vectorImage_0($receiver, vector, callback, continuation, suspended) {
    var instance = new Coroutine$vectorImage_0($receiver, vector, callback, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$vectorImage_0($receiver, vector, callback, continuation) {
    CoroutineImpl.call(this, continuation);
    this.exceptionState_0 = 1;
    this.local$$receiver_0 = void 0;
    this.local$$receiver = $receiver;
    this.local$vector = vector;
    this.local$callback = callback;
  }
  ...
  defineInlineFunction('korui-js.com.soywiz.korui.ui.vectorImage_lz2sxk$', wrapFunction(function () {
    var VectorImage_init = _.com.soywiz.korui.ui.VectorImage;
    return function ($receiver, vector, callback, continuation) {
      var $receiver_1 = new VectorImage_init($receiver.app);
      Kotlin.suspendCall($receiver_1.setVector_qmzsv0$(vector, vector.width, vector.height, Kotlin.coroutineReceiver()));
      callback($receiver_1);
      return $receiver.add_x0aukp$($receiver_1);
    };
  }));
  ...
  VectorImage.prototype.setVector_qmzsv0$ = function (d, width, height, continuation) {
    this.d = d;
    this.targetWidth = width;
    this.targetHeight = height;
    this.style.defaultSize.setTo_6fmdh0$(get_pt(width), get_pt(height));
    ...
    this.img = this.add_x0aukp$($receiver);
  };
  ...
  Object.defineProperty(KoruiEventLoop.prototype, 'instance', {
    get: function () {
      return this.instance_5jnlrf$_0.value;
    }
  });
  ...
  function HtmlLightComponents$addHandler$process(closure$info) {
    return function (e, buttons) {
      var $receiver = closure$info;
      $receiver.x = numberToInt(e.offsetX);
      $receiver.y = numberToInt(e.offsetY);
  ...
  function HtmlLightComponents$addHandler$lambda(closure$listener, closure$process, this$HtmlLightComponents) {
    return function (it) {
      var tmp$, tmp$_0, tmp$_1;
      tmp$_0 = Kotlin.isType(tmp$ = it, MouseEvent) ? tmp$ : throwCCE();
  ...
  HtmlLightComponents.prototype.addHandler_kxnioe$ = function (c, listener) {
    ...
    var process = HtmlLightComponents$addHandler$process(info);
    ...
    if (equals(key, LightProperty$Companion_getInstance().TEXT)) {
      ...
      if (equals(nodeName, 'article')) {
        ...
        if (child['data-type'] == 'checkbox') {
          (tmp$_2 = Kotlin.isType(tmp$_1 = child.querySelector('span'), HTMLSpanElement) ? tmp$_1 : throwCCE()) != null ? (tmp$_2.innerText = v) : null;
        }
         else {
          child.innerText = v;
        }
  ...
  HtmlLightComponents.prototype.setBounds_tiwvvj$ = function (c, x, y, width, height) {
    ...
    if (Kotlin.isType(child, HTMLCanvasElement)) {
      child.width = numberToInt(width * this.devicePixelRatio);
      child.height = numberToInt(height * this.devicePixelRatio);
    }
  };
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda(_korioSuspendCoroutine$lambda(korioSuspendCoroutine$lambda(HtmlLightComponents$dialogAlert$lambda(this.local$message))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda_0(_korioSuspendCoroutine$lambda_0(korioSuspendCoroutine$lambda_0(HtmlLightComponents$dialogPrompt$lambda(this.local$message, this.local$initialValue))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda_1(_korioSuspendCoroutine$lambda_1(korioSuspendCoroutine$lambda_1(HtmlLightComponents$dialogOpenFile$lambda)))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function SelectedFilesVfs$open$ObjectLiteral$_read$lambda$lambda_0(closure$c) {
    return function (it) {
      closure$c.resumeWithException_tcv7n7$(RuntimeException_init('error reading file'));
      return Unit;
    };
  }
  ...
  SelectedFilesVfs$open$ObjectLiteral.prototype._read_m1j1tk$ = function (jsfile_0, position_0, len_0, continuation_0, suspended) {
    var instance = new Coroutine$_read_m1j1tk$(this, jsfile_0, position_0, len_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$_read_m1j1tk$($this, jsfile_0, position_0, len_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$jsfile = jsfile_0;
    this.local$position = position_0;
    this.local$len = len_0;
  }
  Coroutine$_read_m1j1tk$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$_read_m1j1tk$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$_read_m1j1tk$.prototype.constructor = Coroutine$_read_m1j1tk$;
  Coroutine$_read_m1j1tk$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda_2(_korioSuspendCoroutine$lambda_2(korioSuspendCoroutine$lambda_2(SelectedFilesVfs$open$ObjectLiteral$_read$lambda(this.local$jsfile, this.local$position, this.local$len))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            arraycopy(data, 0, this.local$buffer, this.local$offset, data.length);
            return data.length;
        }
      }
       catch (e) {
  ...
  SelectedFilesVfs.prototype.open_j4ip3x$ = function (path, mode, continuation) {
    var tmp$;
    ...
    var jsfile = tmp$;
    var jsstat = this.jsstat_0(jsfile);
    return toAsyncStream(new SelectedFilesVfs$open$ObjectLiteral(jsfile, jsstat));
  };
  ...
  Object.defineProperty(package$korui, 'KORUI_VERSION_8be2vx$', {
    get: function () {
