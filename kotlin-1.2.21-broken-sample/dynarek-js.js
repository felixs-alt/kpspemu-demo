(function (root, factory) {
  ...
  DSlowInterpreter.prototype.interpret_tpas9l$ = function (node) {
    ...
    if (Kotlin.isType(node, DLiteral))
      ...
      switch (node.op.name) {
        case 'ADD':
          return (tmp$_1 = l + r | 0) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : throwCCE();
        case 'MUL':
          return (tmp$_2 = Kotlin.imul(l, r)) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
        default:throw new NotImplementedError_init('An operation is not implemented: ' + ('Unknown op ' + node.op));
      }
    }
     else if (Kotlin.isType(node, DFieldAccess)) {
      var obj = this.interpret_tpas9l$(node.obj);
      return (tmp$_4 = (Kotlin.isType(tmp$_3 = node, DFieldAccess) ? tmp$_3 : throwCCE()).prop.get(obj)) == null || Kotlin.isType(tmp$_4, Any) ? tmp$_4 : throwCCE();
    }
     else {
  ...
  function _generateDynarek(nargs, func) {
    ...
    switch (nargs) {
      ...
      case 2:
        ...
        break;
      default:throw new NotImplementedError_init('An operation is not implemented: ' + ('Unsupported args ' + nargs));
    }
    return tmp$;
  }
  ...
  Object.defineProperty(package$dynarek, 'DYNAREK_VERSION_8be2vx$', {
    get: function () {
