(function (root, factory) {
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            ...
            this.exceptionState_0 = 4;
            this.state_0 = 2;
            this.result_0 = await_0(openUse2$lambda_0(readSoundInfo$lambda(this.local$formats)), this.local$$receiver_0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 2:
        ...
        switch (this.state_0) {
          case 0:
            if (this.local$formats === void 0)
              this.local$formats = defaultAudioFormats;
            this.state_0 = 1;
            this.result_0 = this.local$$receiver.open_7c7tmz$(VfsOpenMode.CREATE_OR_TRUNCATE, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  defineInlineFunction('korau-js.com.soywiz.korau.format.openUse2_7wu7ps$', wrapFunction(function () {
    ...
    return function ($receiver, mode, callback, continuation) {
      ...
      Kotlin.suspendCall($receiver.open_7c7tmz$(mode, Kotlin.coroutineReceiver()));
      var $receiver_1 = Kotlin.coroutineResult(Kotlin.coroutineReceiver());
      try {
        Kotlin.suspendCall(await_0(openUse2$lambda(callback), $receiver_1, Kotlin.coroutineReceiver()));
        Kotlin.coroutineResult(Kotlin.coroutineReceiver());
      }
      finally {
        Kotlin.suspendCall($receiver_1.close(Kotlin.coroutineReceiver()));
      }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            var o = {};
            o['type'] = type;
            var blob = new Blob([this.local$data], o);
  ...
  HtmlNativeSound.prototype.initInternal = function (continuation_0, suspended) {
    var instance = new Coroutine$initInternal(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$initInternal($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$initInternal.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$initInternal.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$initInternal.prototype.constructor = Coroutine$initInternal;
  Coroutine$initInternal.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda(_korioSuspendCoroutine$lambda(suspendCoroutineEL$lambda(suspendCancellableCoroutine$lambda(HtmlNativeSound$initInternal$lambda(this.$this)))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  HtmlNativeSound.prototype.play = function (continuation_0, suspended) {
    var instance = new Coroutine$play_0(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$play_0($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$play_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$play_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$play_0.prototype.constructor = Coroutine$play_0;
  Coroutine$play_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda_0(_korioSuspendCoroutine$lambda_0(suspendCoroutineEL$lambda_0(suspendCancellableCoroutine$lambda_0(HtmlNativeSound$play$lambda(this.$this)))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Object.defineProperty(NativeAudioStream$Companion.prototype, 'context', {
    get: function () {
      return this.context_den50j$_0.value;
    }
  });
  ...
  Object.defineProperty(NativeAudioStream.prototype, 'node', {
    get: function () {
      return this.node_v0owmw$_0.value;
    }
  });
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.$this.buffers.enqueue_11rb$(new PspAudioBuffer(fsamples));
            this.state_0 = 2;
            continue;
          case 1:
            throw this.exception_0;
  ...
  Object.defineProperty(NativeNativeSoundProvider.prototype, 'instance', {
    get: function () {
      return this.instance_tk6otk$_0.value;
    }
  });
  ...
  Object.defineProperty(package$korau, 'KORAU_VERSION_8be2vx$', {
    get: function () {
