(function (root, factory) {
      ...
      while (tmp$_1.hasNext()) {
        ...
        while (tmp$_2.hasNext()) {
          ...
          switch (attribute.type.name) {
            case 'Int1':
              tmp$_3 = 'int(' + toString(vertexMem.getInt32_za3lpa$(o + 0 | 0)) + ')';
              break;
            case 'Float1':
              tmp$_3 = 'float(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ')';
              break;
            case 'Float2':
              tmp$_3 = 'vec2(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 4 | 0)) + ')';
              break;
            case 'Float3':
              tmp$_3 = 'vec3(' + toString(vertexMem.getFloat32_za3lpa$(o + 0 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 4 | 0)) + ',' + toString(vertexMem.getFloat32_za3lpa$(o + 8 | 0)) + ')';
              break;
            case 'Byte4':
              tmp$_3 = 'byte4(' + toString(vertexMem.getInt32_za3lpa$(o + 0 | 0)) + ')';
              break;
  ...
  AGWebgl$WebglProgram.prototype.createShader_19mbxw$ = function (type, source) {
    ...
    if (!success) {
      ...
      throw RuntimeException_init(error);
    }
    return shader;
  };
  ...
  AGWebgl.prototype.draw_n1yu8b$$default = function (vertices, program, type, vertexLayout, vertexCount, indices, offset, blending, uniforms, stencil, colorMask, renderState) {
    ...
    while (tmp$_2.hasNext()) {
      ...
      tmp$_3 = glProgram.uniformLocation_2f4vi3$(uniform);
      if (tmp$_3 == null) {
        continue;
      }
      var location = tmp$_3;
      switch (uniform.type.name) {
        case 'TextureUnit':
          ...
          var tex = (tmp$_5 = unit.texture) == null || Kotlin.isType(tmp$_5, AGWebgl$WebglTexture) ? tmp$_5 : throwCCE();
          ...
          break;
        case 'Mat4':
          this.glUniformMatrix4fv_0(location, false, (Kotlin.isType(tmp$_6 = value, Matrix4) ? tmp$_6 : throwCCE()).data);
          break;
        case 'Float1':
          this.gl.uniform1f(location, numberToDouble(Kotlin.isNumber(tmp$_7 = value) ? tmp$_7 : throwCCE()));
          break;
