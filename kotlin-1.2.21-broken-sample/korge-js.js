(function (root, factory) {
  ...
  function get_stencilIndex($receiver) {
    ...
    getValue_jvq2vc$break: do {
      ...
      if (res == null) {
        ...
        tmp$_4 = (tmp$_3 = stencilIndex.name) != null ? tmp$_3 : stencilIndex_metadata.callableName;
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 1:
            this.local$this$AnSymbolSound.inputSound_0 = this.result_0;
            this.exceptionState_0 = 7;
            this.state_0 = 5;
            continue;
          case 2:
    ...
    getValue_jvq2vc$break: do {
      ...
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = animateLibraryLoaders.name) != null ? tmp$_3 : animateLibraryLoaders_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  AnLibraryPlugin.prototype.register_gohfjx$ = function (views, continuation) {
    views.injector.mapFactory_mvlsy$(getKClass(AnLibrary), AnLibraryPlugin$register$lambda);
  };
      ...
      try {
        switch (this.state_0) {
          ...
          case 6:
            return this.result_0;
          case 7:
            throw IllegalArgumentException_init("Don't know how to load an AnLibrary for file " + this.local$file + ' using loaders: ' + get_animateLibraryLoaders(this.$this.views));
        }
      }
       catch (e) {
        if (this.state_0 === 1) {
      ...
      case 3:
        ...
        switch ($receiver.readU_VL()) {
          ...
          case 1:
            ...
            tmp$ = new VectorPath(IntArrayList_init(cmds), DoubleArrayList_init(data));
            break;
          default:tmp$ = null;
            break;
        }
        ...
        var path = tmp$;
        tmp$_0 = new AnSymbolShape(symbolId, symbolName, bounds_0, new TextureWithBitmapSlice(texture.slice_2da8yn$(textureBounds.toDouble()), slice(bitmap, textureBounds), scale, bounds_0), path);
        break;
      case 6:
  ...
  AtlasPlugin.prototype.register_gohfjx$ = function (views, continuation) {
    views.injector.mapFactory_mvlsy$(getKClass(Atlas), AtlasPlugin$register$lambda);
  };
      ...
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            this.state_0 = 2;
            this.result_0 = readTexture(this.local$folder.get_61zpoe$(this.$this.info.image), this.local$views, void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Atlas$Factory.prototype.create = function (continuation_0, suspended) {
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (endsWith(rpath, '.atlas')) {
              this.state_0 = 3;
              this.result_0 = readAtlas(this.$this.resourcesRoot.get_61zpoe$(rpath).appendExtension_61zpoe$('json'), this.$this.views, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
              ...
              this.state_0 = 2;
              this.result_0 = readAtlas(this.$this.resourcesRoot.get_61zpoe$(rpath), this.$this.views, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  SoundPlugin.prototype.register_gohfjx$ = function (views, continuation) {
    views.injector.mapFactory_mvlsy$(getKClass(SoundFile), SoundPlugin$register$lambda);
  };
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            if ((tmp$ = this.$this.promise_0) != null) {
              this.state_0 = 2;
  ...
  SoundFile$Factory.prototype.create = function (continuation_0, suspended) {
    var instance = new Coroutine$create_2(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$create_2($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$create_2.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$create_2.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$create_2.prototype.constructor = Coroutine$create_2;
  Coroutine$create_2.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  BitmapFontPlugin.prototype.register_gohfjx$ = function (views, continuation) {
    views.injector.mapFactory_mvlsy$(getKClass(BitmapFont), BitmapFontPlugin$register$lambda);
  };
  ...
  BitmapFontAsyncFactory.prototype.create = function (continuation_0, suspended) {
    var instance = new Coroutine$create_3(this, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$create_3($this, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  }
  Coroutine$create_3.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$create_3.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$create_3.prototype.constructor = Coroutine$create_3;
  Coroutine$create_3.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            if (this.$this.path_0 != null) {
              this.state_0 = 5;
              this.result_0 = readBitmapFont(this.$this.resourcesRoot_0.get_xre72y$(this.$this.path_0), this.$this.ag_0, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
             else {
              if (this.$this.vpath_0 != null) {
                this.state_0 = 3;
                this.result_0 = readBitmapFont(this.$this.resourcesRoot_0.get_61zpoe$(this.$this.vpath_0.path), this.$this.ag_0, this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              }
               else {
                if (this.$this.descriptor_0 != null) {
                  return convert(font.BitmapFontGenerator.generate_h6sd2a$(this.$this.descriptor_0.face, this.$this.descriptor_0.size, this.$this.descriptor_0.chars), this.$this.ag_0);
                }
                 else {
  ...
  defineInlineFunction('korge-js.com.soywiz.korge.event.addEventListenerSuspend_r5o1jc$', wrapFunction(function () {
    ...
    return function (T_0, isT, $receiver, handler, continuation) {
      Kotlin.suspendCall(getCoroutineContext(Kotlin.coroutineReceiver()));
      var context_0 = Kotlin.coroutineResult(Kotlin.coroutineReceiver());
  ...
  var Html$Format$computedColor_metadata = new PropertyMetadata('computedColor');
  Object.defineProperty(Html$Format.prototype, 'computedColor', {
    get: function () {
      return this.computedColor_lhqqal$_0.getValue_608w9m$(this, Html$Format$computedColor_metadata);
    }
  });
  ...
  Html$HtmlParser.prototype.parse_tdggph$ = function (xml, format) {
    ...
    if (get_isText(xml))
      ...
      if (get_isNode(xml)) {
        ...
        format.color = color.NamedColors.get_bm4lxs$((tmp$_3 = xml.strNull_61zpoe$('color')) != null ? tmp$_3 : 'white');
    ...
    getValue_jvq2vc$break: do {
      ...
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = extraLanguage.name) != null ? tmp$_3 : extraLanguage_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  function Gestures$Gestures$Direction_init(x, y, $this) {
    ...
    Gestures$Direction.call($this, new PointInt$PointInt$Immutable_init(numberToInt(x), numberToInt(y)));
    return $this;
  }
  Gestures.$metadata$ = {
    kind: Kind_CLASS,
  ...
  var MouseComponent$mouseHitSearch_metadata = new PropertyMetadata('mouseHitSearch');
  MouseComponent.prototype.get_mouseHitSearch_w91h29$ = function ($receiver) {
    ...
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = $this.name) != null ? tmp$ : MouseComponent$mouseHitSearch_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        ...
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = $this.name) != null ? tmp$_3 : MouseComponent$mouseHitSearch_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var MouseComponent$mouseHitResult_metadata = new PropertyMetadata('mouseHitResult');
  MouseComponent.prototype.get_mouseHitResult_w91h29$ = function ($receiver) {
    ...
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = $this.name) != null ? tmp$ : MouseComponent$mouseHitResult_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        var r = $this.defaultGen();
        var tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7;
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = $this.name) != null ? tmp$_3 : MouseComponent$mouseHitResult_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var MouseComponent$mouseHitResultUsed_metadata = new PropertyMetadata('mouseHitResultUsed');
  MouseComponent.prototype.get_mouseHitResultUsed_w91h29$ = function ($receiver) {
    ...
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = $this.name) != null ? tmp$ : MouseComponent$mouseHitResultUsed_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        var r = $this.defaultGen();
        var tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7;
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = $this.name) != null ? tmp$_3 : MouseComponent$mouseHitResultUsed_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  var MouseComponent$mouseDebugHandlerOnce_metadata = new PropertyMetadata('mouseDebugHandlerOnce');
  MouseComponent.prototype.get_mouseDebugHandlerOnce_jv80cy$ = function ($receiver) {
    ...
    getValue_jvq2vc$break: do {
      var tmp$, tmp$_0, tmp$_1, tmp$_2;
      tmp$_1 = $receiver.extra;
      tmp$_0 = (tmp$ = $this.name) != null ? tmp$ : MouseComponent$mouseDebugHandlerOnce_metadata.callableName;
      var res = (tmp$_2 = tmp$_1 != null ? tmp$_1.get_11rb$(tmp$_0) : null) == null || Kotlin.isType(tmp$_2, Any) ? tmp$_2 : throwCCE();
      if (res == null) {
        var r = $this.defaultGen();
        var tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7;
        if ($receiver.extra == null)
          $receiver.extra = lmapOf([]);
        tmp$_7 = $receiver.extra;
        tmp$_4 = (tmp$_3 = $this.name) != null ? tmp$_3 : MouseComponent$mouseDebugHandlerOnce_metadata.callableName;
        tmp$_6 = (tmp$_5 = r) == null || Kotlin.isType(tmp$_5, Any) ? tmp$_5 : throwCCE();
        if (tmp$_7 != null) {
          tmp$_7.put_xwzc9p$(tmp$_4, tmp$_6);
        }
  ...
  SceneContainer.prototype.changeTo_td8rip$ = function (T_0, isT, injects_0, time_0, transition_0, continuation) {
    if (time_0 === void 0) {
    ...
    return this.changeTo_ekc72s$(getKClass(T_0), injects_0.slice(), time_0, transition_0, continuation);
  };
  defineInlineFunction('korge-js.com.soywiz.korge.scene.SceneContainer.changeTo_td8rip$', wrapFunction(function () {
    ...
    return function (T_0, isT, injects_0, time_0, transition_0, continuation) {
      ...
      if (transition_0 === void 0)
        transition_0 = scene.AlphaTransition;
      Kotlin.suspendCall(this.changeTo_ekc72s$(getKClass(T_0), injects_0.slice(), time_0, transition_0, Kotlin.coroutineReceiver()));
      return Kotlin.coroutineResult(Kotlin.coroutineReceiver());
    };
  }));
  SceneContainer.prototype.pushTo_td8rip$ = function (T_0, isT, injects_0, time_0, transition_0, continuation) {
    if (time_0 === void 0) {
      time_0 = TimeSpan.Companion.fromMilliseconds_za3lpa$(numberToInt(numberToDouble(0) * 1000.0));
    }
    if (transition_0 === void 0)
      transition_0 = scene.AlphaTransition;
    return this.pushTo_ekc72s$(getKClass(T_0), injects_0.slice(), time_0, transition_0, continuation);
  };
  defineInlineFunction('korge-js.com.soywiz.korge.scene.SceneContainer.pushTo_td8rip$', wrapFunction(function () {
    ...
    return function (T_0, isT, injects_0, time_0, transition_0, continuation) {
      ...
      if (transition_0 === void 0)
        transition_0 = scene.AlphaTransition;
      Kotlin.suspendCall(this.pushTo_ekc72s$(getKClass(T_0), injects_0.slice(), time_0, transition_0, Kotlin.coroutineReceiver()));
      return Kotlin.coroutineResult(Kotlin.coroutineReceiver());
    };
  }));
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda(_korioSuspendCoroutine$lambda(korioSuspendCoroutine$lambda(TimerComponents$waitMilliseconds$lambda(this.local$time, this.$this))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = suspendCoroutine$lambda_0(_korioSuspendCoroutine$lambda_0(suspendCoroutineEL$lambda(suspendCancellableCoroutine$lambda(tween$lambda_0(this.local$$receiver, this.local$vs, this.local$time, this.local$easing, this.local$callback)))))(this.facade);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FontRepository.prototype.getBitmapFont_bm4lxs$ = function (name, size) {
    ...
    if (!(Kotlin.isType(tmp$_0 = $receiver, Map) ? tmp$_0 : throwCCE()).containsKey_11rb$(nameLC)) {
      this.registerFont_lfzjqc$(name, convert(font.BitmapFontGenerator.generate_h6sd2a$(name, Math_0.min(size, 32), font.BitmapFontGenerator.LATIN_ALL), this.views.ag));
    }
  ...
  Object.defineProperty(Image.prototype, 'sLeft_0', {
    get: function () {
      return (-this.tex.width | 0) * this.anchorX;
    }
  });
  Object.defineProperty(Image.prototype, 'sTop_0', {
    get: function () {
      return (-this.tex.height | 0) * this.anchorY;
    }
  });
